...
typedef void *(VKAPI_PTR *pfn_vk_reallocation_function)(void *p_user_data, void *p_original,
...
vk_destroy_instance(vk_instance instance,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_buffer_view(vk_device device, const vk_buffer_view_create_info *p_create_info,
		      const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_image_view(vk_device device, const vk_image_view_create_info *p_create_info,
		     const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_bind_vertex_buffers(vk_command_buffer command_buffer, uint32_t first_binding,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indexed_indirect(
	...
	uint32_t draw_count, uint32_t stride) __asm("vkCmdDrawIndexedIndirect");
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_wait_events(vk_command_buffer command_buffer, uint32_t event_count, const vk_event *p_events,
		   vk_pipeline_stage_flags src_stage_mask, vk_pipeline_stage_flags dst_stage_mask,
		   uint32_t memory_barrier_count, const vk_memory_barrier *p_memory_barriers,
		   uint32_t buffer_memory_barrier_count,
		   const vk_buffer_memory_barrier *p_buffer_memory_barriers,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_query(vk_command_buffer command_buffer,
					      vk_query_pool query_pool, uint32_t query,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_surface_formats_khr)(
	vk_physical_device physical_device, vk_surface_khr surface,
	uint32_t *p_surface_format_count, vk_surface_format_khr *p_surface_formats);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_surface_formats2khr)(
	vk_physical_device physical_device,
	const vk_physical_device_surface_info2khr *p_surface_info, uint32_t *p_surface_format_count,
...
typedef vk_bool32(VKAPI_PTR *pfn_vk_debug_report_callback_ext)(
	vk_debug_report_flags_ext flags, vk_debug_report_object_type_ext object_type,
	uint64_t object, size_t location, int32_t message_code, const char *p_layer_prefix,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_debug_marker_set_object_name_ext(
	vk_device device, const vk_debug_marker_object_name_info_ext
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_register_display_event_ext(vk_device device, vk_display_khr display,
			      const vk_display_event_info_ext *p_display_event_info,
			      const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_set_debug_utils_object_name_ext(
	vk_device device, const vk_debug_utils_object_name_info_ext
...
typedef void(VKAPI_PTR *pfn_vk_cmd_trace_rays_nv)(
	...
	vk_device_size callable_shader_binding_stride, uint32_t width, uint32_t height,
	uint32_t depth);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_mesh_tasks_indirect_nv(
	vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset,
	uint32_t draw_count, uint32_t stride) __asm("vkCmdDrawMeshTasksIndirectNV");
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_cmd_set_performance_marker_intel(vk_command_buffer command_buffer,
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_cull_mode_ext(vk_command_buffer command_buffer,
