...
typedef void *(VKAPI_PTR *pfn_vk_allocation_function)(void *p_user_data, size_t size,
                                                      size_t                     alignment,
...
typedef void(VKAPI_PTR *pfn_vk_internal_allocation_notification)(
    void *p_user_data, size_t size, vk_internal_allocation_type allocation_type,
    vk_system_allocation_scope allocation_scope);
...
typedef void(VKAPI_PTR *pfn_vk_destroy_instance)(vk_instance                    instance,
                                                 const vk_allocation_callbacks *p_allocator);
...
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_features)(
    vk_physical_device physical_device, vk_physical_device_features *p_features);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties)(
    vk_physical_device physical_device, vk_format format, vk_image_type type,
    vk_image_tiling tiling, vk_image_usage_flags usage, vk_image_create_flags flags,
    vk_image_format_properties *p_image_format_properties);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_properties)(
    vk_physical_device physical_device, vk_physical_device_properties *p_properties);
...
typedef pfn_vk_void_function(VKAPI_PTR *pfn_vk_get_instance_proc_addr)(vk_instance instance,
                                                                       const char *p_name);
typedef pfn_vk_void_function(VKAPI_PTR *pfn_vk_get_device_proc_addr)(vk_device   device,
                                                                     const char *p_name);
typedef vk_result(VKAPI_PTR *pfn_vk_create_device)(vk_physical_device             physical_device,
                                                   ...
                                                   const vk_allocation_callbacks *p_allocator,
                                                   vk_device *                    p_device);
typedef void(VKAPI_PTR *pfn_vk_destroy_device)(vk_device                      device,
                                               const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_instance_extension_properties)(
    const char *p_layer_name, uint32_t *p_property_count, vk_extension_properties *p_properties);
...
typedef void(VKAPI_PTR *pfn_vk_get_device_queue)(vk_device device, uint32_t queue_family_index,
                                                 uint32_t queue_index, vk_queue *p_queue);
...
typedef vk_result(VKAPI_PTR *pfn_vk_allocate_memory)(vk_device                      device,
...
typedef void(VKAPI_PTR *pfn_vk_free_memory)(vk_device device, vk_device_memory memory,
                                            const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_map_memory)(vk_device device, vk_device_memory memory,
                                                vk_device_size offset, vk_device_size size,
                                                vk_memory_map_flags flags, void **pp_data);
...
typedef vk_result(VKAPI_PTR *pfn_vk_flush_mapped_memory_ranges)(
    vk_device device, uint32_t memory_range_count, const vk_mapped_memory_range *p_memory_ranges);
...
typedef void(VKAPI_PTR *pfn_vk_get_device_memory_commitment)(
    vk_device device, vk_device_memory memory, vk_device_size *p_committed_memory_in_bytes);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_buffer_memory)(vk_device device, vk_buffer buffer,
                                                        vk_device_memory memory,
                                                        vk_device_size   memory_offset);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_image_memory)(vk_device device, vk_image image,
                                                       vk_device_memory memory,
                                                       vk_device_size   memory_offset);
typedef void(VKAPI_PTR *pfn_vk_get_buffer_memory_requirements)(
    vk_device device, vk_buffer buffer, vk_memory_requirements *p_memory_requirements);
typedef void(VKAPI_PTR *pfn_vk_get_image_memory_requirements)(
    vk_device device, vk_image image, vk_memory_requirements *p_memory_requirements);
...
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties)(
    vk_physical_device physical_device, vk_format format, vk_image_type type,
    vk_sample_count_flag_bits samples, vk_image_usage_flags usage, vk_image_tiling tiling,
    uint32_t *p_property_count, vk_sparse_image_format_properties *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_queue_bind_sparse)(vk_queue queue, uint32_t bind_info_count,
                                                       ...
                                                       vk_fence                   fence);
typedef vk_result(VKAPI_PTR *pfn_vk_create_fence)(vk_device                      device,
                                                  const vk_fence_create_info *   p_create_info,
                                                  const vk_allocation_callbacks *p_allocator,
                                                  vk_fence *                     p_fence);
typedef void(VKAPI_PTR *pfn_vk_destroy_fence)(vk_device device, vk_fence fence,
                                              const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_fences)(vk_device device, uint32_t fence_count,
                                                  const vk_fence *p_fences);
typedef vk_result(VKAPI_PTR *pfn_vk_get_fence_status)(vk_device device, vk_fence fence);
typedef vk_result(VKAPI_PTR *pfn_vk_wait_for_fences)(vk_device device, uint32_t fence_count,
                                                     const vk_fence *p_fences, vk_bool32 wait_all,
                                                     uint64_t timeout);
typedef vk_result(VKAPI_PTR *pfn_vk_create_semaphore)(vk_device                       device,
...
typedef void(VKAPI_PTR *pfn_vk_destroy_semaphore)(vk_device device, vk_semaphore semaphore,
                                                  const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_event)(vk_device                      device,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_query_pool)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_query_pool *p_query_pool);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_query_pool_results)(
    vk_device device, vk_query_pool query_pool, uint32_t first_query, uint32_t query_count,
    size_t data_size, void *p_data, vk_device_size stride, vk_query_result_flags flags);
typedef vk_result(VKAPI_PTR *pfn_vk_create_buffer)(vk_device                      device,
...
typedef void(VKAPI_PTR *pfn_vk_destroy_buffer_view)(vk_device device, vk_buffer_view buffer_view,
                                                    const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_image)(vk_device                      device,
...
typedef void(VKAPI_PTR *pfn_vk_get_image_subresource_layout)(
    vk_device device, vk_image image, const vk_image_subresource *p_subresource,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_shader_module)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_shader_module *p_shader_module);
typedef void(VKAPI_PTR *pfn_vk_destroy_shader_module)(vk_device                      device,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_pipeline_cache)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_pipeline_cache *p_pipeline_cache);
typedef void(VKAPI_PTR *pfn_vk_destroy_pipeline_cache)(vk_device         device,
                                                       vk_pipeline_cache pipeline_cache,
                                                       const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_pipeline_cache_data)(vk_device         device,
                                                             vk_pipeline_cache pipeline_cache,
                                                             size_t *p_data_size, void *p_data);
typedef vk_result(VKAPI_PTR *pfn_vk_merge_pipeline_caches)(vk_device                device,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_pipeline_layout)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_pipeline_layout *p_pipeline_layout);
typedef void(VKAPI_PTR *pfn_vk_destroy_pipeline_layout)(vk_device          device,
                                                        vk_pipeline_layout pipeline_layout,
                                                        const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_sampler)(vk_device                      device,
                                                    const vk_sampler_create_info * p_create_info,
                                                    const vk_allocation_callbacks *p_allocator,
                                                    vk_sampler *                   p_sampler);
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_descriptor_pool)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_descriptor_pool *p_descriptor_pool);
typedef void(VKAPI_PTR *pfn_vk_destroy_descriptor_pool)(vk_device          device,
                                                        vk_descriptor_pool descriptor_pool,
                                                        const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_descriptor_pool)(vk_device          device,
                                                           vk_descriptor_pool descriptor_pool,
                                                           vk_descriptor_pool_reset_flags flags);
typedef vk_result(VKAPI_PTR *pfn_vk_allocate_descriptor_sets)(
    vk_device device, const vk_descriptor_set_allocate_info *p_allocate_info,
    vk_descriptor_set *p_descriptor_sets);
typedef vk_result(VKAPI_PTR *pfn_vk_free_descriptor_sets)(
    vk_device device, vk_descriptor_pool descriptor_pool, uint32_t descriptor_set_count,
...
typedef void(VKAPI_PTR *pfn_vk_update_descriptor_sets)(
    ...
    const vk_write_descriptor_set *p_descriptor_writes, uint32_t descriptor_copy_count,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_framebuffer)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_framebuffer *p_framebuffer);
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_render_pass)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_render_pass *p_render_pass);
typedef void(VKAPI_PTR *pfn_vk_destroy_render_pass)(vk_device device, vk_render_pass render_pass,
                                                    const vk_allocation_callbacks *p_allocator);
typedef void(VKAPI_PTR *pfn_vk_get_render_area_granularity)(vk_device      device,
                                                            vk_render_pass render_pass,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_command_pool)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_command_pool *p_command_pool);
typedef void(VKAPI_PTR *pfn_vk_destroy_command_pool)(vk_device device, vk_command_pool command_pool,
                                                     const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_command_pool)(vk_device                   device,
                                                        vk_command_pool             command_pool,
                                                        vk_command_pool_reset_flags flags);
typedef vk_result(VKAPI_PTR *pfn_vk_allocate_command_buffers)(
    vk_device device, const vk_command_buffer_allocate_info *p_allocate_info,
...
typedef vk_result(VKAPI_PTR *pfn_vk_begin_command_buffer)(
    vk_command_buffer command_buffer, const vk_command_buffer_begin_info *p_begin_info);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_viewport)(vk_command_buffer command_buffer,
                                                 uint32_t first_viewport, uint32_t viewport_count,
                                                 const vk_viewport *p_viewports);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_scissor)(vk_command_buffer command_buffer,
                                                uint32_t first_scissor, uint32_t scissor_count,
                                                const vk_rect2d *p_scissors);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_line_width)(vk_command_buffer command_buffer,
                                                   float             line_width);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_bias)(vk_command_buffer command_buffer,
                                                   float             depth_bias_constant_factor,
                                                   float             depth_bias_clamp,
                                                   float             depth_bias_slope_factor);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_blend_constants)(vk_command_buffer command_buffer,
                                                        const float       blend_constants[4]);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_bounds)(vk_command_buffer command_buffer,
                                                     float             min_depth_bounds,
                                                     float             max_depth_bounds);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_descriptor_sets)(
    vk_command_buffer command_buffer, vk_pipeline_bind_point pipeline_bind_point,
    vk_pipeline_layout layout, uint32_t first_set, uint32_t descriptor_set_count,
    const vk_descriptor_set *p_descriptor_sets, uint32_t dynamic_offset_count,
    const uint32_t *p_dynamic_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_index_buffer)(vk_command_buffer command_buffer,
                                                      vk_buffer buffer, vk_device_size offset,
                                                      vk_index_type index_type);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_vertex_buffers)(vk_command_buffer     command_buffer,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw)(vk_command_buffer command_buffer, uint32_t vertex_count,
                                         ...
                                         uint32_t first_instance);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed)(vk_command_buffer command_buffer,
                                                 uint32_t index_count, uint32_t instance_count,
                                                 uint32_t first_index, int32_t vertex_offset,
                                                 uint32_t first_instance);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect)(vk_command_buffer command_buffer,
                                                  vk_buffer buffer, vk_device_size offset,
                                                  uint32_t draw_count, uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect)(vk_command_buffer command_buffer,
                                                          vk_buffer buffer, vk_device_size offset,
                                                          uint32_t draw_count, uint32_t stride);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch_indirect)(vk_command_buffer command_buffer,
                                                      vk_buffer buffer, vk_device_size offset);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer)(vk_command_buffer command_buffer,
                                                vk_buffer src_buffer, vk_buffer dst_buffer,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer_to_image)(vk_command_buffer command_buffer,
                                                         vk_buffer src_buffer, vk_image dst_image,
                                                         vk_image_layout dst_image_layout,
                                                         uint32_t        region_count,
                                                         const vk_buffer_image_copy *p_regions);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_image_to_buffer)(
    vk_command_buffer command_buffer, vk_image src_image, vk_image_layout src_image_layout,
    vk_buffer dst_buffer, uint32_t region_count, const vk_buffer_image_copy *p_regions);
typedef void(VKAPI_PTR *pfn_vk_cmd_update_buffer)(vk_command_buffer command_buffer,
                                                  vk_buffer dst_buffer, vk_device_size dst_offset,
                                                  vk_device_size data_size, const void *p_data);
typedef void(VKAPI_PTR *pfn_vk_cmd_fill_buffer)(vk_command_buffer command_buffer,
                                                vk_buffer dst_buffer, vk_device_size dst_offset,
                                                vk_device_size size, uint32_t data);
typedef void(VKAPI_PTR *pfn_vk_cmd_clear_color_image)(vk_command_buffer command_buffer,
                                                      vk_image image, vk_image_layout image_layout,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_clear_depth_stencil_image)(
    vk_command_buffer command_buffer, vk_image image, vk_image_layout image_layout,
    const vk_clear_depth_stencil_value *p_depth_stencil, uint32_t range_count,
    const vk_image_subresource_range *p_ranges);
typedef void(VKAPI_PTR *pfn_vk_cmd_clear_attachments)(vk_command_buffer          command_buffer,
                                                      uint32_t                   attachment_count,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_resolve_image)(
    vk_command_buffer command_buffer, vk_image src_image, vk_image_layout src_image_layout,
    vk_image dst_image, vk_image_layout dst_image_layout, uint32_t region_count,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_wait_events)(
    ...
    vk_pipeline_stage_flags src_stage_mask, vk_pipeline_stage_flags dst_stage_mask,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_pipeline_barrier)(
    vk_command_buffer command_buffer, vk_pipeline_stage_flags src_stage_mask,
    vk_pipeline_stage_flags dst_stage_mask, vk_dependency_flags dependency_flags,
    uint32_t memory_barrier_count, const vk_memory_barrier *p_memory_barriers,
    uint32_t buffer_memory_barrier_count, const vk_buffer_memory_barrier *p_buffer_memory_barriers,
    uint32_t image_memory_barrier_count, const vk_image_memory_barrier *p_image_memory_barriers);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_query)(vk_command_buffer command_buffer,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_end_query)(vk_command_buffer command_buffer,
                                              vk_query_pool query_pool, uint32_t query);
typedef void(VKAPI_PTR *pfn_vk_cmd_reset_query_pool)(vk_command_buffer command_buffer,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_query_pool_results)(
    vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t first_query,
    uint32_t query_count, vk_buffer dst_buffer, vk_device_size dst_offset, vk_device_size stride,
    vk_query_result_flags flags);
typedef void(VKAPI_PTR *pfn_vk_cmd_push_constants)(vk_command_buffer     command_buffer,
                                                   vk_pipeline_layout    layout,
                                                   vk_shader_stage_flags stage_flags,
                                                   uint32_t offset, uint32_t size,
                                                   const void *p_values);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_render_pass)(
    vk_command_buffer command_buffer, const vk_render_pass_begin_info *p_render_pass_begin,
    vk_subpass_contents contents);
typedef void(VKAPI_PTR *pfn_vk_cmd_next_subpass)(vk_command_buffer   command_buffer,
                                                 vk_subpass_contents contents);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_render_pass)(vk_command_buffer command_buffer);
typedef void(VKAPI_PTR *pfn_vk_cmd_execute_commands)(vk_command_buffer        command_buffer,
                                                     uint32_t                 command_buffer_count,
                                                     const vk_command_buffer *p_command_buffers);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_instance(
    const vk_instance_create_info *p_create_info, const vk_allocation_callbacks *p_allocator,
    vk_instance *p_instance) __asm("vkCreateInstance");

VKAPI_ATTR void VKAPI_CALL vk_destroy_instance(
    vk_instance instance, const vk_allocation_callbacks *p_allocator) __asm("vkDestroyInstance");
...
vk_get_instance_proc_addr(vk_instance instance, const char *p_name) __asm("vkGetInstanceProcAddr");

VKAPI_ATTR pfn_vk_void_function VKAPI_CALL
vk_get_device_proc_addr(vk_device device, const char *p_name) __asm("vkGetDeviceProcAddr");
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_device(
    vk_device device, const vk_allocation_callbacks *p_allocator) __asm("vkDestroyDevice");
...
VKAPI_ATTR void VKAPI_CALL vk_get_device_queue(vk_device device, uint32_t queue_family_index,
                                               uint32_t  queue_index,
                                               vk_queue *p_queue) __asm("vkGetDeviceQueue");

VKAPI_ATTR vk_result VKAPI_CALL vk_queue_submit(vk_queue queue, uint32_t submit_count,
...
vk_allocate_memory(vk_device device, const vk_memory_allocate_info *p_allocate_info,
                   const vk_allocation_callbacks *p_allocator,
                   vk_device_memory *             p_memory) __asm("vkAllocateMemory");

VKAPI_ATTR void VKAPI_CALL
vk_free_memory(vk_device device, vk_device_memory memory,
               const vk_allocation_callbacks *p_allocator) __asm("vkFreeMemory");

VKAPI_ATTR vk_result VKAPI_CALL vk_map_memory(vk_device device, vk_device_memory memory,
                                              vk_device_size offset, vk_device_size size,
                                              vk_memory_map_flags flags,
                                              void **             pp_data) __asm("vkMapMemory");

VKAPI_ATTR void VKAPI_CALL vk_unmap_memory(vk_device        device,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_bind_buffer_memory(vk_device device, vk_buffer buffer, vk_device_memory memory,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_fence(vk_device                      device,
                                                const vk_fence_create_info *   p_create_info,
                                                const vk_allocation_callbacks *p_allocator,
                                                vk_fence *p_fence) __asm("vkCreateFence");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_fence(vk_device device, vk_fence fence,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_fence_status(vk_device device,
                                                    vk_fence  fence) __asm("vkGetFenceStatus");

VKAPI_ATTR vk_result VKAPI_CALL vk_wait_for_fences(vk_device device, uint32_t fence_count,
                                                   const vk_fence *p_fences, vk_bool32 wait_all,
                                                   uint64_t timeout) __asm("vkWaitForFences");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_semaphore(vk_device device, const vk_semaphore_create_info *p_create_info,
                    const vk_allocation_callbacks *p_allocator,
                    vk_semaphore *                 p_semaphore) __asm("vkCreateSemaphore");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_semaphore(vk_device device, vk_semaphore semaphore,
                     const vk_allocation_callbacks *p_allocator) __asm("vkDestroySemaphore");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_event(vk_device                      device,
                                                const vk_event_create_info *   p_create_info,
                                                const vk_allocation_callbacks *p_allocator,
                                                vk_event *p_event) __asm("vkCreateEvent");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_event(vk_device device, vk_event event,
                 const vk_allocation_callbacks *p_allocator) __asm("vkDestroyEvent");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_event_status(vk_device device,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_reset_event(vk_device device,
                                               vk_event  event) __asm("vkResetEvent");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_query_pool(vk_device device, const vk_query_pool_create_info *p_create_info,
                     const vk_allocation_callbacks *p_allocator,
                     vk_query_pool *                p_query_pool) __asm("vkCreateQueryPool");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_query_pool(vk_device device, vk_query_pool query_pool,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_buffer(vk_device                      device,
                                                 const vk_buffer_create_info *  p_create_info,
                                                 const vk_allocation_callbacks *p_allocator,
                                                 vk_buffer *p_buffer) __asm("vkCreateBuffer");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_buffer(vk_device device, vk_buffer buffer,
                  const vk_allocation_callbacks *p_allocator) __asm("vkDestroyBuffer");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_buffer_view(
    vk_device device, const vk_buffer_view_create_info *p_create_info,
    const vk_allocation_callbacks *p_allocator, vk_buffer_view *p_view) __asm("vkCreateBufferView");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_image(vk_device                      device,
                                                const vk_image_create_info *   p_create_info,
                                                const vk_allocation_callbacks *p_allocator,
                                                vk_image *p_image) __asm("vkCreateImage");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_image(vk_device device, vk_image image,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_image_view(
    vk_device device, const vk_image_view_create_info *p_create_info,
    const vk_allocation_callbacks *p_allocator, vk_image_view *p_view) __asm("vkCreateImageView");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_image_view(vk_device device, vk_image_view image_view,
                      const vk_allocation_callbacks *p_allocator) __asm("vkDestroyImageView");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_shader_module(vk_device device, const vk_shader_module_create_info *p_create_info,
                        const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_pipeline_cache(vk_device device, const vk_pipeline_cache_create_info *p_create_info,
                         const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_get_pipeline_cache_data(vk_device device, vk_pipeline_cache pipeline_cache, size_t *p_data_size,
...
VKAPI_ATTR void VKAPI_CALL
vk_destroy_pipeline(vk_device device, vk_pipeline pipeline,
                    const vk_allocation_callbacks *p_allocator) __asm("vkDestroyPipeline");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_pipeline_layout(vk_device device, const vk_pipeline_layout_create_info *p_create_info,
                          const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_sampler(vk_device                      device,
                                                  const vk_sampler_create_info * p_create_info,
                                                  const vk_allocation_callbacks *p_allocator,
                                                  vk_sampler *p_sampler) __asm("vkCreateSampler");

VKAPI_ATTR void VKAPI_CALL
vk_destroy_sampler(vk_device device, vk_sampler sampler,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_descriptor_pool(vk_device device, const vk_descriptor_pool_create_info *p_create_info,
                          const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_framebuffer(vk_device device, const vk_framebuffer_create_info *p_create_info,
                      const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_render_pass(vk_device device, const vk_render_pass_create_info *p_create_info,
                      const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR void VKAPI_CALL
vk_get_render_area_granularity(vk_device device, vk_render_pass render_pass,
                               vk_extent_2d *p_granularity) __asm("vkGetRenderAreaGranularity");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_command_pool(vk_device device, const vk_command_pool_create_info *p_create_info,
                       const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_reset_command_pool(vk_device device, vk_command_pool command_pool,
...
VKAPI_ATTR void VKAPI_CALL vk_free_command_buffers(
    vk_device device, vk_command_pool command_pool, uint32_t command_buffer_count,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_end_command_buffer(vk_command_buffer command_buffer) __asm("vkEndCommandBuffer");

VKAPI_ATTR vk_result VKAPI_CALL
vk_reset_command_buffer(vk_command_buffer             command_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_scissor(vk_command_buffer command_buffer,
                                              uint32_t first_scissor, uint32_t scissor_count,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_bias(
    vk_command_buffer command_buffer, float depth_bias_constant_factor, float depth_bias_clamp,
    float depth_bias_slope_factor) __asm("vkCmdSetDepthBias");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_blend_constants(vk_command_buffer command_buffer,
                           const float       blend_constants[4]) __asm("vkCmdSetBlendConstants");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_depth_bounds(vk_command_buffer command_buffer, float min_depth_bounds,
                        float max_depth_bounds) __asm("vkCmdSetDepthBounds");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_stencil_compare_mask(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
                                uint32_t compare_mask) __asm("vkCmdSetStencilCompareMask");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_stencil_write_mask(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
                              uint32_t write_mask) __asm("vkCmdSetStencilWriteMask");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_stencil_reference(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_bind_index_buffer(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset,
                         vk_index_type index_type) __asm("vkCmdBindIndexBuffer");

VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_vertex_buffers(
    vk_command_buffer command_buffer, uint32_t first_binding, uint32_t binding_count,
    const vk_buffer *p_buffers, const vk_device_size *p_offsets) __asm("vkCmdBindVertexBuffers");

VKAPI_ATTR void VKAPI_CALL vk_cmd_draw(vk_command_buffer command_buffer, uint32_t vertex_count,
                                       uint32_t instance_count, uint32_t first_vertex,
                                       uint32_t first_instance) __asm("vkCmdDraw");

VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indexed(vk_command_buffer command_buffer,
                                               uint32_t index_count, uint32_t instance_count,
                                               uint32_t first_index, int32_t vertex_offset,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indexed_indirect(
    vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, uint32_t draw_count,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_copy_buffer(vk_command_buffer command_buffer, vk_buffer src_buffer, vk_buffer dst_buffer,
                   uint32_t region_count, const vk_buffer_copy *p_regions) __asm("vkCmdCopyBuffer");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_blit_image(vk_command_buffer command_buffer, vk_image src_image,
                                             vk_image_layout src_image_layout, vk_image dst_image,
                                             vk_image_layout dst_image_layout,
                                             uint32_t region_count, const vk_image_blit *p_regions,
                                             vk_filter filter) __asm("vkCmdBlitImage");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_buffer_to_image(
    vk_command_buffer command_buffer, vk_buffer src_buffer, vk_image dst_image,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_update_buffer(vk_command_buffer command_buffer,
                                                vk_buffer dst_buffer, vk_device_size dst_offset,
                                                vk_device_size data_size,
                                                const void *   p_data) __asm("vkCmdUpdateBuffer");

VKAPI_ATTR void VKAPI_CALL vk_cmd_fill_buffer(vk_command_buffer command_buffer,
                                              vk_buffer dst_buffer, vk_device_size dst_offset,
                                              vk_device_size size,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_clear_color_image(
    vk_command_buffer command_buffer, vk_image image, vk_image_layout image_layout,
    const vk_clear_color_value *p_color, uint32_t range_count,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_clear_attachments(vk_command_buffer command_buffer, uint32_t attachment_count,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_begin_query(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t query,
                   vk_query_control_flags flags) __asm("vkCmdBeginQuery");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_query(vk_command_buffer command_buffer,
                                            vk_query_pool     query_pool,
                                            uint32_t          query) __asm("vkCmdEndQuery");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_reset_query_pool(vk_command_buffer command_buffer, vk_query_pool query_pool,
                        uint32_t first_query, uint32_t query_count) __asm("vkCmdResetQueryPool");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_push_constants(vk_command_buffer     command_buffer,
                                                 vk_pipeline_layout    layout,
                                                 vk_shader_stage_flags stage_flags, uint32_t offset,
                                                 uint32_t    size,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_next_subpass(
    vk_command_buffer command_buffer, vk_subpass_contents contents) __asm("vkCmdNextSubpass");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_end_render_pass(vk_command_buffer command_buffer) __asm("vkCmdEndRenderPass");
...
typedef vk_result(VKAPI_PTR *pfn_vk_bind_buffer_memory2)(
    vk_device device, uint32_t bind_info_count, const vk_bind_buffer_memory_info *p_bind_infos);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_image_memory2)(
    vk_device device, uint32_t bind_info_count, const vk_bind_image_memory_info *p_bind_infos);
typedef void(VKAPI_PTR *pfn_vk_get_device_group_peer_memory_features)(
    ...
    uint32_t remote_device_index, vk_peer_memory_feature_flags *p_peer_memory_features);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_device_mask)(vk_command_buffer command_buffer,
                                                    uint32_t          device_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch_base)(vk_command_buffer command_buffer,
...
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_features2)(
    vk_physical_device physical_device, vk_physical_device_features2 *p_features);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_properties2)(
    vk_physical_device physical_device, vk_physical_device_properties2 *p_properties);
...
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties2)(
    vk_physical_device                                  physical_device,
    const vk_physical_device_sparse_image_format_info2 *p_format_info, uint32_t *p_property_count,
...
typedef void(VKAPI_PTR *pfn_vk_get_device_queue2)(vk_device                    device,
...
typedef void(VKAPI_PTR *pfn_vk_update_descriptor_set_with_template)(
    ...
    vk_descriptor_update_template descriptor_update_template, const void *p_data);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch_base(vk_command_buffer command_buffer,
                                                uint32_t base_group_x, uint32_t base_group_y,
                                                uint32_t base_group_z, uint32_t group_count_x,
                                                uint32_t group_count_y,
...
VKAPI_ATTR void VKAPI_CALL
vk_trim_command_pool(vk_device device, vk_command_pool command_pool,
                     vk_command_pool_trim_flags flags) __asm("vkTrimCommandPool");

VKAPI_ATTR void VKAPI_CALL vk_get_device_queue2(vk_device                    device,
                                                const vk_device_queue_info2 *p_queue_info,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_count)(vk_command_buffer command_buffer,
                                                        vk_buffer buffer, vk_device_size offset,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count)(
    vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset,
    vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count,
    uint32_t stride);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_end_render_pass2)(vk_command_buffer          command_buffer,
                                                     const vk_subpass_end_info *p_subpass_end_info);
typedef void(VKAPI_PTR *pfn_vk_reset_query_pool)(vk_device device, vk_query_pool query_pool,
                                                 uint32_t first_query, uint32_t query_count);
typedef vk_result(VKAPI_PTR *pfn_vk_get_semaphore_counter_value)(vk_device    device,
                                                                 vk_semaphore semaphore,
                                                                 uint64_t *   p_value);
typedef vk_result(VKAPI_PTR *pfn_vk_wait_semaphores)(vk_device                     device,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_render_pass2(vk_device device, const vk_render_pass_create_info2 *p_create_info,
                       const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_next_subpass2(
    vk_command_buffer command_buffer, const vk_subpass_begin_info *p_subpass_begin_info,
    const vk_subpass_end_info *p_subpass_end_info) __asm("vkCmdNextSubpass2");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_end_render_pass2(vk_command_buffer          command_buffer,
                        const vk_subpass_end_info *p_subpass_end_info) __asm("vkCmdEndRenderPass2");

VKAPI_ATTR void VKAPI_CALL vk_reset_query_pool(vk_device device, vk_query_pool query_pool,
                                               uint32_t first_query,
                                               uint32_t query_count) __asm("vkResetQueryPool");

VKAPI_ATTR vk_result VKAPI_CALL
vk_get_semaphore_counter_value(vk_device device, vk_semaphore semaphore,
                               uint64_t *p_value) __asm("vkGetSemaphoreCounterValue");

VKAPI_ATTR vk_result VKAPI_CALL vk_wait_semaphores(vk_device                     device,
                                                   const vk_semaphore_wait_info *p_wait_info,
                                                   uint64_t timeout) __asm("vkWaitSemaphores");

VKAPI_ATTR vk_result VKAPI_CALL vk_signal_semaphore(
    vk_device device, const vk_semaphore_signal_info *p_signal_info) __asm("vkSignalSemaphore");
...
VKAPI_ATTR uint64_t VKAPI_CALL vk_get_device_memory_opaque_capture_address(
    vk_device              device, const vk_device_memory_opaque_capture_address_info
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_swapchain_khr)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_swapchain_khr *p_swapchain);
typedef void(VKAPI_PTR *pfn_vk_destroy_swapchain_khr)(vk_device device, vk_swapchain_khr swapchain,
                                                      const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_swapchain_images_khr)(vk_device        device,
                                                              vk_swapchain_khr swapchain,
                                                              uint32_t *p_swapchain_image_count,
                                                              vk_image *p_swapchain_images);
typedef vk_result(VKAPI_PTR *pfn_vk_acquire_next_image_khr)(vk_device        device,
                                                            vk_swapchain_khr swapchain,
                                                            uint64_t         timeout,
                                                            vk_semaphore semaphore, vk_fence fence,
                                                            uint32_t *p_image_index);
typedef vk_result(VKAPI_PTR *pfn_vk_queue_present_khr)(vk_queue                   queue,
                                                       const vk_present_info_khr *p_present_info);
typedef vk_result(VKAPI_PTR *pfn_vk_get_device_group_present_capabilities_khr)(
    vk_device                                 device,
    vk_device_group_present_capabilities_khr *p_device_group_present_capabilities);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_swapchain_khr(vk_device device, const vk_swapchain_create_info_khr *p_create_info,
                        const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_swapchain_images_khr(
    vk_device device, vk_swapchain_khr swapchain, uint32_t *p_swapchain_image_count,
    vk_image *p_swapchain_images) __asm("vkGetSwapchainImagesKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_next_image_khr(
    vk_device device, vk_swapchain_khr swapchain, uint64_t timeout, vk_semaphore semaphore,
    vk_fence fence, uint32_t *p_image_index) __asm("vkAcquireNextImageKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_queue_present_khr(
    vk_queue queue, const vk_present_info_khr *p_present_info) __asm("vkQueuePresentKHR");
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_acquire_next_image2khr(vk_device device, const vk_acquire_next_image_info_khr *p_acquire_info,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_display_mode_khr)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_display_mode_khr *p_mode);
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_display_mode_khr(vk_physical_device physical_device, vk_display_khr display,
                           const vk_display_mode_create_info_khr *p_create_info,
                           const vk_allocation_callbacks *        p_allocator,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_shared_swapchains_khr)(
    ...
    const vk_allocation_callbacks *p_allocator, vk_swapchain_khr *p_swapchains);
...
typedef void(VKAPI_PTR *pfn_vk_get_device_group_peer_memory_features_khr)(
    vk_device device, uint32_t heap_index, uint32_t local_device_index,
    uint32_t remote_device_index, vk_peer_memory_feature_flags *p_peer_memory_features);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_device_mask_khr)(vk_command_buffer command_buffer,
                                                        uint32_t          device_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch_base_khr)(vk_command_buffer command_buffer,
                                                      uint32_t base_group_x, uint32_t base_group_y,
                                                      uint32_t base_group_z, uint32_t group_count_x,
                                                      uint32_t group_count_y,
                                                      uint32_t group_count_z);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_device_mask_khr(
    vk_command_buffer command_buffer, uint32_t device_mask) __asm("vkCmdSetDeviceMaskKHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch_base_khr(
    vk_command_buffer command_buffer, uint32_t base_group_x, uint32_t base_group_y,
    uint32_t base_group_z, uint32_t group_count_x, uint32_t group_count_y,
...
typedef void(VKAPI_PTR *pfn_vk_trim_command_pool_khr)(vk_device                  device,
                                                      vk_command_pool            command_pool,
                                                      vk_command_pool_trim_flags flags);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_trim_command_pool_khr(vk_device device, vk_command_pool command_pool,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_memory_fd_khr)(
    vk_device device, const vk_memory_get_fd_info_khr *p_get_fd_info, int *p_fd);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_memory_fd_khr(vk_device                        device,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_semaphore_fd_khr)(
    vk_device device, const vk_semaphore_get_fd_info_khr *p_get_fd_info, int *p_fd);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_import_semaphore_fd_khr(
    vk_device              device, const vk_import_semaphore_fd_info_khr
                          *p_import_semaphore_fd_info) __asm("vkImportSemaphoreFdKHR");

VKAPI_ATTR vk_result VKAPI_CALL
vk_get_semaphore_fd_khr(vk_device device, const vk_semaphore_get_fd_info_khr *p_get_fd_info,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_end_render_pass2khr)(
    vk_command_buffer command_buffer, const vk_subpass_end_info *p_subpass_end_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_render_pass2khr(vk_device device, const vk_render_pass_create_info2 *p_create_info,
                          const vk_allocation_callbacks *p_allocator,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_swapchain_status_khr)(vk_device        device,
                                                              vk_swapchain_khr swapchain);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_swapchain_status_khr(
    vk_device device, vk_swapchain_khr swapchain) __asm("vkGetSwapchainStatusKHR");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_import_fence_fd_khr)(
    vk_device device, const vk_import_fence_fd_info_khr *p_import_fence_fd_info);
typedef vk_result(VKAPI_PTR *pfn_vk_get_fence_fd_khr)(vk_device                       device,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_fence_fd_khr(vk_device                       device,
                                                    const vk_fence_get_fd_info_khr *p_get_fd_info,
...
typedef vk_result(
    VKAPI_PTR *pfn_vk_enumerate_physical_device_queue_family_performance_query_counters_khr)(
...
vk_enumerate_physical_device_queue_family_performance_query_counters_khr(
    ...
    vk_performance_counter_khr *p_counters,
    vk_performance_counter_description_khr
        *p_counter_descriptions) __asm("vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCounter"
                                       "sKHR");
...
VKAPI_ATTR void VKAPI_CALL
vk_release_profiling_lock_khr(vk_device device) __asm("vkReleaseProfilingLockKHR");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_count_khr)(vk_command_buffer command_buffer,
                                                            vk_buffer buffer, vk_device_size offset,
                                                            vk_buffer      count_buffer,
                                                            vk_device_size count_buffer_offset,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_semaphore_counter_value_khr)(vk_device    device,
                                                                     vk_semaphore semaphore,
                                                                     uint64_t *   p_value);
typedef vk_result(VKAPI_PTR *pfn_vk_wait_semaphores_khr)(vk_device                     device,
                                                         const vk_semaphore_wait_info *p_wait_info,
                                                         uint64_t                      timeout);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL
vk_get_semaphore_counter_value_khr(vk_device device, vk_semaphore semaphore,
                                   uint64_t *p_value) __asm("vkGetSemaphoreCounterValueKHR");

VKAPI_ATTR vk_result VKAPI_CALL
vk_wait_semaphores_khr(vk_device device, const vk_semaphore_wait_info *p_wait_info,
                       uint64_t timeout) __asm("vkWaitSemaphoresKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_signal_semaphore_khr(
    vk_device device, const vk_semaphore_signal_info *p_signal_info) __asm("vkSignalSemaphoreKHR");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_pipeline_executable_statistics_khr)(
    ...
    uint32_t *p_statistic_count, vk_pipeline_executable_statistic_khr *p_statistics);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer2khr)(
    vk_command_buffer command_buffer, const vk_copy_buffer_info2khr *p_copy_buffer_info);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_resolve_image2khr)(
    vk_command_buffer command_buffer, const vk_resolve_image_info2khr *p_resolve_image_info);
...
typedef vk_bool32(VKAPI_PTR *pfn_vk_debug_report_callback_ext)(
    vk_debug_report_flags_ext flags, vk_debug_report_object_type_ext object_type, uint64_t object,
    size_t location, int32_t message_code, const char *p_layer_prefix, const char *p_message,
    void *p_user_data);
...
typedef void(VKAPI_PTR *pfn_vk_debug_report_message_ext)(
    ...
    vk_debug_report_object_type_ext object_type, uint64_t object, size_t location,
    int32_t message_code, const char *p_layer_prefix, const char *p_message);
...
VKAPI_ATTR void VKAPI_CALL
vk_debug_report_message_ext(vk_instance instance, vk_debug_report_flags_ext flags,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_debug_marker_begin_ext)(
    vk_command_buffer command_buffer, const vk_debug_marker_marker_info_ext *p_marker_info);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_transform_feedback_buffers_ext)(
    vk_command_buffer command_buffer, uint32_t first_binding, uint32_t binding_count,
    const vk_buffer *p_buffers, const vk_device_size *p_offsets, const vk_device_size *p_sizes);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_transform_feedback_ext)(
    ...
    const vk_buffer *p_counter_buffers, const vk_device_size *p_counter_buffer_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_transform_feedback_ext)(
    vk_command_buffer command_buffer, uint32_t first_counter_buffer, uint32_t counter_buffer_count,
    const vk_buffer *p_counter_buffers, const vk_device_size *p_counter_buffer_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_query_indexed_ext)(vk_command_buffer      command_buffer,
                                                            vk_query_pool          query_pool,
                                                            uint32_t               query,
                                                            vk_query_control_flags flags,
                                                            uint32_t               index);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_query_indexed_ext)(vk_command_buffer command_buffer,
                                                          vk_query_pool query_pool, uint32_t query,
                                                          uint32_t index);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_byte_count_ext)(
    vk_command_buffer command_buffer, uint32_t instance_count, uint32_t first_instance,
    vk_buffer counter_buffer, vk_device_size counter_buffer_offset, uint32_t counter_offset,
    uint32_t vertex_stride);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_transform_feedback_buffers_ext(
    vk_command_buffer command_buffer, uint32_t first_binding, uint32_t binding_count,
    const vk_buffer *p_buffers, const vk_device_size *p_offsets,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_query_indexed_ext(
    vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t query,
    vk_query_control_flags flags, uint32_t index) __asm("vkCmdBeginQueryIndexedEXT");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_end_query_indexed_ext(vk_command_buffer command_buffer, vk_query_pool query_pool,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_image_view_address_nvx)(
    vk_device device, vk_image_view image_view, vk_image_view_address_properties_nvx *p_properties);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_count_amd)(vk_command_buffer command_buffer,
                                                            vk_buffer buffer, vk_device_size offset,
                                                            vk_buffer      count_buffer,
                                                            vk_device_size count_buffer_offset,
                                                            uint32_t       max_draw_count,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_shader_info_amd)(vk_device device, vk_pipeline pipeline,
                                                         ...
                                                         size_t *p_info_size, void *p_info);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_external_image_format_properties_nv(
    ...
    vk_external_memory_handle_type_flags_nv external_handle_type,
    vk_external_image_format_properties_nv
        *p_external_image_format_properties) __asm("vkGetPhysicalDeviceExternalImageFormatPropertie"
                                                   "sNV");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_conditional_rendering_ext)(
    vk_command_buffer                              command_buffer,
    const vk_conditional_rendering_begin_info_ext *p_conditional_rendering_begin);
...
typedef vk_result(VKAPI_PTR *pfn_vk_release_display_ext)(vk_physical_device physical_device,
                                                         vk_display_khr     display);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_release_display_ext(
    vk_physical_device physical_device, vk_display_khr display) __asm("vkReleaseDisplayEXT");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_register_display_event_ext)(
    vk_device device, vk_display_khr display, const vk_display_event_info_ext *p_display_event_info,
    const vk_allocation_callbacks *p_allocator, vk_fence *p_fence);
typedef vk_result(VKAPI_PTR *pfn_vk_get_swapchain_counter_ext)(
    vk_device device, vk_swapchain_khr swapchain, vk_surface_counter_flag_bits_ext counter,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_register_device_event_ext(vk_device device, const vk_device_event_info_ext *p_device_event_info,
                             const vk_allocation_callbacks *p_allocator,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_discard_rectangle_ext)(
    ...
    uint32_t discard_rectangle_count, const vk_rect2d *p_discard_rectangles);
...
VKAPI_ATTR void VKAPI_CALL vk_set_hdr_metadata_ext(
    vk_device device, uint32_t swapchain_count, const vk_swapchain_khr *p_swapchains,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_debug_utils_label_ext)(
    vk_command_buffer command_buffer, const vk_debug_utils_label_ext *p_label_info);
...
VKAPI_ATTR void VKAPI_CALL
vk_queue_end_debug_utils_label_ext(vk_queue queue) __asm("vkQueueEndDebugUtilsLabelEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_end_debug_utils_label_ext(vk_command_buffer command_buffer) __asm(
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_sample_locations_ext(vk_command_buffer command_buffer,
...
typedef vk_result(VKAPI_PTR *pfn_vk_merge_validation_caches_ext)(
    vk_device device, vk_validation_cache_ext dst_cache, uint32_t src_cache_count,
    const vk_validation_cache_ext *p_src_caches);
typedef vk_result(VKAPI_PTR *pfn_vk_get_validation_cache_data_ext)(
    vk_device device, vk_validation_cache_ext validation_cache, size_t *p_data_size, void *p_data);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_validation_cache_data_ext(
    vk_device device, vk_validation_cache_ext validation_cache, size_t *p_data_size,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_build_acceleration_structure_nv)(
    vk_command_buffer command_buffer, const vk_acceleration_structure_info_nv *p_info,
    vk_buffer instance_data, vk_device_size instance_offset, vk_bool32 update,
    vk_acceleration_structure_khr dst, vk_acceleration_structure_khr src, vk_buffer scratch,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_acceleration_structure_nv)(
    ...
    vk_acceleration_structure_khr src, vk_copy_acceleration_structure_mode_khr mode);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_ray_tracing_shader_group_handles_khr)(
    vk_device device, vk_pipeline pipeline, uint32_t first_group, uint32_t group_count,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_acceleration_structure_handle_nv)(
    vk_device device, vk_acceleration_structure_khr acceleration_structure, size_t data_size,
    void *p_data);
typedef void(VKAPI_PTR *pfn_vk_cmd_write_acceleration_structures_properties_khr)(
    ...
    const vk_acceleration_structure_khr *p_acceleration_structures, vk_query_type query_type,
    vk_query_pool query_pool, uint32_t first_query);
typedef void(VKAPI_PTR *pfn_vk_cmd_write_acceleration_structures_properties_nv)(
    vk_command_buffer command_buffer, uint32_t acceleration_structure_count,
    const vk_acceleration_structure_khr *p_acceleration_structures, vk_query_type query_type,
    vk_query_pool query_pool, uint32_t first_query);
typedef vk_result(VKAPI_PTR *pfn_vk_compile_deferred_nv)(vk_device device, vk_pipeline pipeline,
                                                         uint32_t shader);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_ray_tracing_shader_group_handles_khr(
    vk_device device, vk_pipeline pipeline, uint32_t first_group, uint32_t group_count,
    size_t data_size, void *p_data) __asm("vkGetRayTracingShaderGroupHandlesKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_ray_tracing_shader_group_handles_nv(
    vk_device device, vk_pipeline pipeline, uint32_t first_group, uint32_t group_count,
    size_t data_size, void *p_data) __asm("vkGetRayTracingShaderGroupHandlesNV");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_compile_deferred_nv(
    vk_device device, vk_pipeline pipeline, uint32_t shader) __asm("vkCompileDeferredNV");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_write_buffer_marker_amd)(
    vk_command_buffer command_buffer, vk_pipeline_stage_flag_bits pipeline_stage,
    vk_buffer dst_buffer, vk_device_size dst_offset, uint32_t marker);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_calibrated_timestamps_ext)(
    ...
    const vk_calibrated_timestamp_info_ext *p_timestamp_infos, uint64_t *p_timestamps,
    uint64_t *p_max_deviation);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_nv)(vk_command_buffer command_buffer,
                                                       uint32_t task_count, uint32_t first_task);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_indirect_nv)(vk_command_buffer command_buffer,
                                                                vk_buffer         buffer,
                                                                vk_device_size    offset,
                                                                uint32_t          draw_count,
                                                                uint32_t          stride);
...
typedef void(VKAPI_PTR *pfn_vk_get_queue_checkpoint_data_nv)(
    vk_queue queue, uint32_t *p_checkpoint_data_count, vk_checkpoint_data_nv *p_checkpoint_data);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_checkpoint_nv(vk_command_buffer command_buffer,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_initialize_performance_api_intel(
    vk_device              device, const vk_initialize_performance_api_info_intel
...
VKAPI_ATTR vk_result VKAPI_CALL vk_release_performance_configuration_intel(
    vk_device             device, vk_performance_configuration_intel
...
VKAPI_ATTR vk_result VKAPI_CALL vk_queue_set_performance_configuration_intel(
    vk_queue            queue, vk_performance_configuration_intel
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_set_local_dimming_amd(vk_device device, vk_swapchain_khr swap_chain,
...
typedef vk_result(
    VKAPI_PTR *pfn_vk_get_physical_device_supported_framebuffer_mixed_samples_combinations_nv)(
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_line_stipple_ext)(vk_command_buffer command_buffer,
                                                         uint32_t          line_stipple_factor,
                                                         uint16_t          line_stipple_pattern);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_line_stipple_ext(vk_command_buffer command_buffer, uint32_t line_stipple_factor,
...
typedef void(VKAPI_PTR *pfn_vk_reset_query_pool_ext)(vk_device device, vk_query_pool query_pool,
                                                     uint32_t first_query, uint32_t query_count);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_reset_query_pool_ext(vk_device device, vk_query_pool query_pool, uint32_t first_query,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_cull_mode_ext)(vk_command_buffer  command_buffer,
                                                      vk_cull_mode_flags cull_mode);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_front_face_ext)(vk_command_buffer command_buffer,
                                                       vk_front_face     front_face);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_primitive_topology_ext)(
    vk_command_buffer command_buffer, vk_primitive_topology primitive_topology);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_viewport_with_count_ext)(vk_command_buffer  command_buffer,
                                                                uint32_t           viewport_count,
                                                                const vk_viewport *p_viewports);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_scissor_with_count_ext)(vk_command_buffer command_buffer,
                                                               uint32_t          scissor_count,
                                                               const vk_rect2d * p_scissors);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_cull_mode_ext(
    vk_command_buffer command_buffer, vk_cull_mode_flags cull_mode) __asm("vkCmdSetCullModeEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_front_face_ext(
    vk_command_buffer command_buffer, vk_front_face front_face) __asm("vkCmdSetFrontFaceEXT");
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_depth_test_enable_ext(vk_command_buffer command_buffer,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_depth_compare_op_ext(vk_command_buffer command_buffer,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_stencil_op_ext(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
                          vk_stencil_op fail_op, vk_stencil_op pass_op, vk_stencil_op depth_fail_op,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_pipeline_shader_group_nv(
    vk_command_buffer command_buffer, vk_pipeline_bind_point pipeline_bind_point,
    vk_pipeline pipeline, uint32_t group_index) __asm("vkCmdBindPipelineShaderGroupNV");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_set_private_data_ext(vk_device                device,
                                                        vk_object_type           object_type,
                                                        uint64_t                 object_handle,
                                                        vk_private_data_slot_ext private_data_slot,
                                                        uint64_t data) __asm("vkSetPrivateDataEXT");

VKAPI_ATTR void VKAPI_CALL vk_get_private_data_ext(vk_device device, vk_object_type object_type,
                                                   uint64_t                 object_handle,
                                                   vk_private_data_slot_ext private_data_slot,
