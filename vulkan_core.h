...
typedef void *(VKAPI_PTR *pfn_vk_allocation_function)(
	void *p_user_data, size_t size, size_t alignment,
	vk_system_allocation_scope allocation_scope);

typedef void(VKAPI_PTR *pfn_vk_free_function)(void *p_user_data,
					      void *p_memory);

typedef void(VKAPI_PTR *pfn_vk_internal_allocation_notification)(
	void *p_user_data, size_t size,
...
typedef void *(VKAPI_PTR *pfn_vk_reallocation_function)(
	void *p_user_data, void *p_original, size_t size, size_t alignment,
	vk_system_allocation_scope allocation_scope);
...
typedef struct vk_pipeline_vertex_input_state_create_info {
	...
	const vk_vertex_input_attribute_description
...
typedef struct vk_graphics_pipeline_create_info {
	...
	const vk_pipeline_input_assembly_state_create_info
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_instance)(
	const vk_instance_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_instance *p_instance);
typedef void(VKAPI_PTR *pfn_vk_destroy_instance)(
	vk_instance instance, const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_physical_devices)(
	vk_instance instance, uint32_t *p_physical_device_count,
	vk_physical_device *p_physical_devices);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_features)(
	vk_physical_device physical_device,
	vk_physical_device_features *p_features);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_format_properties)(
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties)(
	vk_physical_device physical_device, vk_format format,
	vk_image_type type, vk_image_tiling tiling, vk_image_usage_flags usage,
	vk_image_create_flags flags,
	vk_image_format_properties *p_image_format_properties);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_properties)(
	vk_physical_device physical_device,
...
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_memory_properties)(
	vk_physical_device physical_device,
	vk_physical_device_memory_properties *p_memory_properties);
typedef pfn_vk_void_function(VKAPI_PTR *pfn_vk_get_instance_proc_addr)(
	vk_instance instance, const char *p_name);
typedef pfn_vk_void_function(VKAPI_PTR *pfn_vk_get_device_proc_addr)(
	vk_device device, const char *p_name);
typedef vk_result(VKAPI_PTR *pfn_vk_create_device)(
	vk_physical_device physical_device,
	const vk_device_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_device *p_device);
typedef void(VKAPI_PTR *pfn_vk_destroy_device)(
	vk_device device, const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_instance_extension_properties)(
	const char *p_layer_name, uint32_t *p_property_count,
	vk_extension_properties *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_device_extension_properties)(
	vk_physical_device physical_device, const char *p_layer_name,
	uint32_t *p_property_count, vk_extension_properties *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_instance_layer_properties)(
	uint32_t *p_property_count, vk_layer_properties *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_device_layer_properties)(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_layer_properties *p_properties);
typedef void(VKAPI_PTR *pfn_vk_get_device_queue)(vk_device device,
						 uint32_t queue_family_index,
						 uint32_t queue_index,
						 vk_queue *p_queue);
typedef vk_result(VKAPI_PTR *pfn_vk_queue_submit)(
	vk_queue queue, uint32_t submit_count, const vk_submit_info *p_submits,
	vk_fence fence);
...
typedef vk_result(VKAPI_PTR *pfn_vk_allocate_memory)(
	vk_device device, const vk_memory_allocate_info *p_allocate_info,
	const vk_allocation_callbacks *p_allocator, vk_device_memory *p_memory);
typedef void(VKAPI_PTR *pfn_vk_free_memory)(
	vk_device device, vk_device_memory memory,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_map_memory)(
	vk_device device, vk_device_memory memory, vk_device_size offset,
	vk_device_size size, vk_memory_map_flags flags, void **pp_data);
typedef void(VKAPI_PTR *pfn_vk_unmap_memory)(vk_device device,
					     vk_device_memory memory);
typedef vk_result(VKAPI_PTR *pfn_vk_flush_mapped_memory_ranges)(
	vk_device device, uint32_t memory_range_count,
	const vk_mapped_memory_range *p_memory_ranges);
typedef vk_result(VKAPI_PTR *pfn_vk_invalidate_mapped_memory_ranges)(
	vk_device device, uint32_t memory_range_count,
	const vk_mapped_memory_range *p_memory_ranges);
typedef void(VKAPI_PTR *pfn_vk_get_device_memory_commitment)(
	vk_device device, vk_device_memory memory,
	vk_device_size *p_committed_memory_in_bytes);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_buffer_memory)(
	vk_device device, vk_buffer buffer, vk_device_memory memory,
	vk_device_size memory_offset);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_image_memory)(
	vk_device device, vk_image image, vk_device_memory memory,
	vk_device_size memory_offset);
typedef void(VKAPI_PTR *pfn_vk_get_buffer_memory_requirements)(
	vk_device device, vk_buffer buffer,
	vk_memory_requirements *p_memory_requirements);
typedef void(VKAPI_PTR *pfn_vk_get_image_memory_requirements)(
...
typedef void(
	VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties)(
	vk_physical_device physical_device, vk_format format,
	vk_image_type type, vk_sample_count_flag_bits samples,
	vk_image_usage_flags usage, vk_image_tiling tiling,
	uint32_t *p_property_count,
	vk_sparse_image_format_properties *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_queue_bind_sparse)(
	vk_queue queue, uint32_t bind_info_count,
	const vk_bind_sparse_info *p_bind_info, vk_fence fence);
typedef vk_result(VKAPI_PTR *pfn_vk_create_fence)(
	vk_device device, const vk_fence_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_fence *p_fence);
typedef void(VKAPI_PTR *pfn_vk_destroy_fence)(
	vk_device device, vk_fence fence,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_fences)(vk_device device,
						  uint32_t fence_count,
						  const vk_fence *p_fences);
typedef vk_result(VKAPI_PTR *pfn_vk_get_fence_status)(vk_device device,
						      vk_fence fence);
typedef vk_result(VKAPI_PTR *pfn_vk_wait_for_fences)(vk_device device,
						     uint32_t fence_count,
						     const vk_fence *p_fences,
						     vk_bool32 wait_all,
						     uint64_t timeout);
typedef vk_result(VKAPI_PTR *pfn_vk_create_semaphore)(
	vk_device device, const vk_semaphore_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_semaphore *p_semaphore);
typedef void(VKAPI_PTR *pfn_vk_destroy_semaphore)(
	vk_device device, vk_semaphore semaphore,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_event)(
	vk_device device, const vk_event_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_event *p_event);
typedef void(VKAPI_PTR *pfn_vk_destroy_event)(
	vk_device device, vk_event event,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_event_status)(vk_device device,
						      vk_event event);
typedef vk_result(VKAPI_PTR *pfn_vk_set_event)(vk_device device,
					       vk_event event);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_event)(vk_device device,
						 vk_event event);
typedef vk_result(VKAPI_PTR *pfn_vk_create_query_pool)(
	vk_device device, const vk_query_pool_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_query_pool *p_query_pool);
typedef void(VKAPI_PTR *pfn_vk_destroy_query_pool)(
	vk_device device, vk_query_pool query_pool,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_query_pool_results)(
	vk_device device, vk_query_pool query_pool, uint32_t first_query,
	uint32_t query_count, size_t data_size, void *p_data,
	vk_device_size stride, vk_query_result_flags flags);
typedef vk_result(VKAPI_PTR *pfn_vk_create_buffer)(
	vk_device device, const vk_buffer_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_buffer *p_buffer);
typedef void(VKAPI_PTR *pfn_vk_destroy_buffer)(
	vk_device device, vk_buffer buffer,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_buffer_view)(
	vk_device device, const vk_buffer_view_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_buffer_view *p_view);
typedef void(VKAPI_PTR *pfn_vk_destroy_buffer_view)(
	vk_device device, vk_buffer_view buffer_view,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_image)(
	vk_device device, const vk_image_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_image *p_image);
typedef void(VKAPI_PTR *pfn_vk_destroy_image)(
	vk_device device, vk_image image,
	const vk_allocation_callbacks *p_allocator);
typedef void(VKAPI_PTR *pfn_vk_get_image_subresource_layout)(
	vk_device device, vk_image image,
	const vk_image_subresource *p_subresource,
	vk_subresource_layout *p_layout);
typedef vk_result(VKAPI_PTR *pfn_vk_create_image_view)(
	vk_device device, const vk_image_view_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_image_view *p_view);
typedef void(VKAPI_PTR *pfn_vk_destroy_image_view)(
	vk_device device, vk_image_view image_view,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_shader_module)(
	vk_device device, const vk_shader_module_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_shader_module *p_shader_module);
typedef void(VKAPI_PTR *pfn_vk_destroy_shader_module)(
	vk_device device, vk_shader_module shader_module,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_pipeline_cache)(
	vk_device device, const vk_pipeline_cache_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_pipeline_cache *p_pipeline_cache);
typedef void(VKAPI_PTR *pfn_vk_destroy_pipeline_cache)(
	vk_device device, vk_pipeline_cache pipeline_cache,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_pipeline_cache_data)(
	vk_device device, vk_pipeline_cache pipeline_cache, size_t *p_data_size,
	void *p_data);
typedef vk_result(VKAPI_PTR *pfn_vk_merge_pipeline_caches)(
	vk_device device, vk_pipeline_cache dst_cache, uint32_t src_cache_count,
	const vk_pipeline_cache *p_src_caches);
typedef vk_result(VKAPI_PTR *pfn_vk_create_graphics_pipelines)(
	vk_device device, vk_pipeline_cache pipeline_cache,
	uint32_t create_info_count,
	const vk_graphics_pipeline_create_info *p_create_infos,
	const vk_allocation_callbacks *p_allocator, vk_pipeline *p_pipelines);
typedef vk_result(VKAPI_PTR *pfn_vk_create_compute_pipelines)(
	vk_device device, vk_pipeline_cache pipeline_cache,
	uint32_t create_info_count,
	const vk_compute_pipeline_create_info *p_create_infos,
	const vk_allocation_callbacks *p_allocator, vk_pipeline *p_pipelines);
typedef void(VKAPI_PTR *pfn_vk_destroy_pipeline)(
	vk_device device, vk_pipeline pipeline,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_pipeline_layout)(
	vk_device device, const vk_pipeline_layout_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_pipeline_layout *p_pipeline_layout);
typedef void(VKAPI_PTR *pfn_vk_destroy_pipeline_layout)(
	vk_device device, vk_pipeline_layout pipeline_layout,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_sampler)(
	vk_device device, const vk_sampler_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator, vk_sampler *p_sampler);
typedef void(VKAPI_PTR *pfn_vk_destroy_sampler)(
	vk_device device, vk_sampler sampler,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_descriptor_set_layout)(
	vk_device device,
	const vk_descriptor_set_layout_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_descriptor_set_layout *p_set_layout);
typedef void(VKAPI_PTR *pfn_vk_destroy_descriptor_set_layout)(
	vk_device device, vk_descriptor_set_layout descriptor_set_layout,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_descriptor_pool)(
	vk_device device, const vk_descriptor_pool_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_descriptor_pool *p_descriptor_pool);
typedef void(VKAPI_PTR *pfn_vk_destroy_descriptor_pool)(
	vk_device device, vk_descriptor_pool descriptor_pool,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_descriptor_pool)(
	vk_device device, vk_descriptor_pool descriptor_pool,
	vk_descriptor_pool_reset_flags flags);
typedef vk_result(VKAPI_PTR *pfn_vk_allocate_descriptor_sets)(
	vk_device device,
	const vk_descriptor_set_allocate_info *p_allocate_info,
	vk_descriptor_set *p_descriptor_sets);
typedef vk_result(VKAPI_PTR *pfn_vk_free_descriptor_sets)(
	vk_device device, vk_descriptor_pool descriptor_pool,
	uint32_t descriptor_set_count,
	const vk_descriptor_set *p_descriptor_sets);
typedef void(VKAPI_PTR *pfn_vk_update_descriptor_sets)(
	vk_device device, uint32_t descriptor_write_count,
	const vk_write_descriptor_set *p_descriptor_writes,
	uint32_t descriptor_copy_count,
	const vk_copy_descriptor_set *p_descriptor_copies);
typedef vk_result(VKAPI_PTR *pfn_vk_create_framebuffer)(
	vk_device device, const vk_framebuffer_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_framebuffer *p_framebuffer);
typedef void(VKAPI_PTR *pfn_vk_destroy_framebuffer)(
	vk_device device, vk_framebuffer framebuffer,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_create_render_pass)(
	vk_device device, const vk_render_pass_create_info *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_render_pass *p_render_pass);
typedef void(VKAPI_PTR *pfn_vk_destroy_render_pass)(
...
typedef void(VKAPI_PTR *pfn_vk_destroy_command_pool)(
	vk_device device, vk_command_pool command_pool,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_command_pool)(
	vk_device device, vk_command_pool command_pool,
	vk_command_pool_reset_flags flags);
typedef vk_result(VKAPI_PTR *pfn_vk_allocate_command_buffers)(
	vk_device device,
	const vk_command_buffer_allocate_info *p_allocate_info,
	vk_command_buffer *p_command_buffers);
typedef void(VKAPI_PTR *pfn_vk_free_command_buffers)(
	vk_device device, vk_command_pool command_pool,
	uint32_t command_buffer_count,
	const vk_command_buffer *p_command_buffers);
typedef vk_result(VKAPI_PTR *pfn_vk_begin_command_buffer)(
	vk_command_buffer command_buffer,
	const vk_command_buffer_begin_info *p_begin_info);
typedef vk_result(VKAPI_PTR *pfn_vk_end_command_buffer)(
	vk_command_buffer command_buffer);
typedef vk_result(VKAPI_PTR *pfn_vk_reset_command_buffer)(
	vk_command_buffer command_buffer, vk_command_buffer_reset_flags flags);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_pipeline)(
	vk_command_buffer command_buffer,
	vk_pipeline_bind_point pipeline_bind_point, vk_pipeline pipeline);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_viewport)(
	vk_command_buffer command_buffer, uint32_t first_viewport,
	uint32_t viewport_count, const vk_viewport *p_viewports);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_scissor)(
	vk_command_buffer command_buffer, uint32_t first_scissor,
	uint32_t scissor_count, const vk_rect2d *p_scissors);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_line_width)(
	vk_command_buffer command_buffer, float line_width);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_bias)(
	vk_command_buffer command_buffer, float depth_bias_constant_factor,
	float depth_bias_clamp, float depth_bias_slope_factor);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_blend_constants)(
	vk_command_buffer command_buffer, const float blend_constants[4]);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_bounds)(
	vk_command_buffer command_buffer, float min_depth_bounds,
	float max_depth_bounds);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_stencil_compare_mask)(
	vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
	uint32_t compare_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_stencil_write_mask)(
	vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
	uint32_t write_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_stencil_reference)(
	vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
	uint32_t reference);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_descriptor_sets)(
	vk_command_buffer command_buffer,
	vk_pipeline_bind_point pipeline_bind_point, vk_pipeline_layout layout,
	uint32_t first_set, uint32_t descriptor_set_count,
	const vk_descriptor_set *p_descriptor_sets,
	uint32_t dynamic_offset_count, const uint32_t *p_dynamic_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_index_buffer)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_index_type index_type);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_vertex_buffers)(
	vk_command_buffer command_buffer, uint32_t first_binding,
	uint32_t binding_count, const vk_buffer *p_buffers,
	const vk_device_size *p_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw)(vk_command_buffer command_buffer,
					 uint32_t vertex_count,
					 uint32_t instance_count,
					 uint32_t first_vertex,
					 uint32_t first_instance);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed)(
	vk_command_buffer command_buffer, uint32_t index_count,
	uint32_t instance_count, uint32_t first_index, int32_t vertex_offset,
	uint32_t first_instance);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, uint32_t draw_count, uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, uint32_t draw_count, uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch)(vk_command_buffer command_buffer,
					     uint32_t group_count_x,
					     uint32_t group_count_y,
					     uint32_t group_count_z);
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch_indirect)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer)(
	vk_command_buffer command_buffer, vk_buffer src_buffer,
	vk_buffer dst_buffer, uint32_t region_count,
	const vk_buffer_copy *p_regions);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_image)(vk_command_buffer command_buffer,
					       vk_image src_image,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_blit_image)(
	vk_command_buffer command_buffer, vk_image src_image,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer_to_image)(
	vk_command_buffer command_buffer, vk_buffer src_buffer,
	vk_image dst_image, vk_image_layout dst_image_layout,
	uint32_t region_count, const vk_buffer_image_copy *p_regions);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_image_to_buffer)(
	vk_command_buffer command_buffer, vk_image src_image,
	vk_image_layout src_image_layout, vk_buffer dst_buffer,
	uint32_t region_count, const vk_buffer_image_copy *p_regions);
typedef void(VKAPI_PTR *pfn_vk_cmd_update_buffer)(
	vk_command_buffer command_buffer, vk_buffer dst_buffer,
	vk_device_size dst_offset, vk_device_size data_size,
	const void *p_data);
typedef void(VKAPI_PTR *pfn_vk_cmd_fill_buffer)(
	vk_command_buffer command_buffer, vk_buffer dst_buffer,
	vk_device_size dst_offset, vk_device_size size, uint32_t data);
typedef void(VKAPI_PTR *pfn_vk_cmd_clear_color_image)(
	vk_command_buffer command_buffer, vk_image image,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_clear_depth_stencil_image)(
	vk_command_buffer command_buffer, vk_image image,
	vk_image_layout image_layout,
	const vk_clear_depth_stencil_value *p_depth_stencil,
	uint32_t range_count, const vk_image_subresource_range *p_ranges);
typedef void(VKAPI_PTR *pfn_vk_cmd_clear_attachments)(
	vk_command_buffer command_buffer, uint32_t attachment_count,
	const vk_clear_attachment *p_attachments, uint32_t rect_count,
	const vk_clear_rect *p_rects);
typedef void(VKAPI_PTR *pfn_vk_cmd_resolve_image)(
	vk_command_buffer command_buffer, vk_image src_image,
	vk_image_layout src_image_layout, vk_image dst_image,
	vk_image_layout dst_image_layout, uint32_t region_count,
	const vk_image_resolve *p_regions);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_event)(
	vk_command_buffer command_buffer, vk_event event,
	vk_pipeline_stage_flags stage_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_reset_event)(
	vk_command_buffer command_buffer, vk_event event,
	vk_pipeline_stage_flags stage_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_wait_events)(
	vk_command_buffer command_buffer, uint32_t event_count,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_pipeline_barrier)(
	...
	vk_pipeline_stage_flags src_stage_mask,
	vk_pipeline_stage_flags dst_stage_mask,
	vk_dependency_flags dependency_flags, uint32_t memory_barrier_count,
	const vk_memory_barrier *p_memory_barriers,
	uint32_t buffer_memory_barrier_count,
	const vk_buffer_memory_barrier *p_buffer_memory_barriers,
	uint32_t image_memory_barrier_count,
	const vk_image_memory_barrier *p_image_memory_barriers);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_query)(
	vk_command_buffer command_buffer, vk_query_pool query_pool,
	uint32_t query, vk_query_control_flags flags);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_query)(vk_command_buffer command_buffer,
					      vk_query_pool query_pool,
					      uint32_t query);
typedef void(VKAPI_PTR *pfn_vk_cmd_reset_query_pool)(
	vk_command_buffer command_buffer, vk_query_pool query_pool,
	uint32_t first_query, uint32_t query_count);
typedef void(VKAPI_PTR *pfn_vk_cmd_write_timestamp)(
	vk_command_buffer command_buffer,
	vk_pipeline_stage_flag_bits pipeline_stage, vk_query_pool query_pool,
	uint32_t query);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_query_pool_results)(
	vk_command_buffer command_buffer, vk_query_pool query_pool,
	uint32_t first_query, uint32_t query_count, vk_buffer dst_buffer,
	vk_device_size dst_offset, vk_device_size stride,
	vk_query_result_flags flags);
typedef void(VKAPI_PTR *pfn_vk_cmd_push_constants)(
	vk_command_buffer command_buffer, vk_pipeline_layout layout,
	vk_shader_stage_flags stage_flags, uint32_t offset, uint32_t size,
	const void *p_values);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_render_pass)(
	vk_command_buffer command_buffer,
	const vk_render_pass_begin_info *p_render_pass_begin,
	vk_subpass_contents contents);
typedef void(VKAPI_PTR *pfn_vk_cmd_next_subpass)(
	vk_command_buffer command_buffer, vk_subpass_contents contents);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_render_pass)(
	vk_command_buffer command_buffer);
typedef void(VKAPI_PTR *pfn_vk_cmd_execute_commands)(
	vk_command_buffer command_buffer, uint32_t command_buffer_count,
	const vk_command_buffer *p_command_buffers);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_instance(const vk_instance_create_info *p_create_info,
		   const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_physical_devices(
	vk_instance instance, uint32_t *p_physical_device_count,
	vk_physical_device
		*p_physical_devices) __asm("vkEnumeratePhysicalDevices");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_features(
	vk_physical_device physical_device,
	vk_physical_device_features
		*p_features) __asm("vkGetPhysicalDeviceFeatures");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_format_properties(
	vk_physical_device physical_device, vk_format format,
	vk_format_properties *
		p_format_properties) __asm("vkGetPhysicalDeviceFormatProperties");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_image_format_properties(
	...
	vk_image_create_flags flags,
	vk_image_format_properties *
		p_image_format_properties) __asm("vkGetPhysicalDeviceImageFormatProperties");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_properties(
	vk_physical_device physical_device,
	vk_physical_device_properties
		*p_properties) __asm("vkGetPhysicalDeviceProperties");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_queue_family_properties(
	vk_physical_device physical_device,
	uint32_t *p_queue_family_property_count,
	vk_queue_family_properties *
		p_queue_family_properties) __asm("vkGetPhysicalDeviceQueueFamilyProperties");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_memory_properties(
	vk_physical_device physical_device,
	vk_physical_device_memory_properties *
		p_memory_properties) __asm("vkGetPhysicalDeviceMemoryProperties");

VKAPI_ATTR pfn_vk_void_function VKAPI_CALL
vk_get_instance_proc_addr(vk_instance instance,
			  const char *p_name) __asm("vkGetInstanceProcAddr");

VKAPI_ATTR pfn_vk_void_function VKAPI_CALL vk_get_device_proc_addr(
	vk_device device, const char *p_name) __asm("vkGetDeviceProcAddr");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_device(vk_physical_device physical_device,
		 const vk_device_create_info *p_create_info,
		 const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_instance_extension_properties(
	const char *p_layer_name, uint32_t *p_property_count,
	vk_extension_properties
		*p_properties) __asm("vkEnumerateInstanceExtensionProperties");

VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_device_extension_properties(
	vk_physical_device physical_device, const char *p_layer_name,
	uint32_t *p_property_count,
	vk_extension_properties
		*p_properties) __asm("vkEnumerateDeviceExtensionProperties");

VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_instance_layer_properties(
	uint32_t *p_property_count,
	vk_layer_properties
		*p_properties) __asm("vkEnumerateInstanceLayerProperties");

VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_device_layer_properties(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_layer_properties
		*p_properties) __asm("vkEnumerateDeviceLayerProperties");

VKAPI_ATTR void VKAPI_CALL vk_get_device_queue(
	vk_device device, uint32_t queue_family_index, uint32_t queue_index,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_queue_wait_idle(vk_queue queue) __asm("vkQueueWaitIdle");

VKAPI_ATTR vk_result VKAPI_CALL
vk_device_wait_idle(vk_device device) __asm("vkDeviceWaitIdle");
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_map_memory(vk_device device, vk_device_memory memory, vk_device_size offset,
	      vk_device_size size, vk_memory_map_flags flags,
	      void **pp_data) __asm("vkMapMemory");

VKAPI_ATTR void VKAPI_CALL vk_unmap_memory(
	vk_device device, vk_device_memory memory) __asm("vkUnmapMemory");

VKAPI_ATTR vk_result VKAPI_CALL vk_flush_mapped_memory_ranges(
	vk_device device, uint32_t memory_range_count,
	const vk_mapped_memory_range
		*p_memory_ranges) __asm("vkFlushMappedMemoryRanges");

VKAPI_ATTR vk_result VKAPI_CALL vk_invalidate_mapped_memory_ranges(
	vk_device device, uint32_t memory_range_count,
	const vk_mapped_memory_range
		*p_memory_ranges) __asm("vkInvalidateMappedMemoryRanges");

VKAPI_ATTR void VKAPI_CALL vk_get_device_memory_commitment(
	vk_device device, vk_device_memory memory,
	vk_device_size *
		p_committed_memory_in_bytes) __asm("vkGetDeviceMemoryCommitment");
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_bind_image_memory(vk_device device, vk_image image, vk_device_memory memory,
		     vk_device_size memory_offset) __asm("vkBindImageMemory");

VKAPI_ATTR void VKAPI_CALL vk_get_buffer_memory_requirements(
	vk_device device, vk_buffer buffer,
	vk_memory_requirements
		*p_memory_requirements) __asm("vkGetBufferMemoryRequirements");

VKAPI_ATTR void VKAPI_CALL vk_get_image_memory_requirements(
	vk_device device, vk_image image,
	vk_memory_requirements
		*p_memory_requirements) __asm("vkGetImageMemoryRequirements");

VKAPI_ATTR void VKAPI_CALL vk_get_image_sparse_memory_requirements(
	vk_device device, vk_image image,
	uint32_t *p_sparse_memory_requirement_count,
	vk_sparse_image_memory_requirements *
		p_sparse_memory_requirements) __asm("vkGetImageSparseMemoryRequirements");
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_sparse_image_format_properties(
	...
	uint32_t *p_property_count,
	vk_sparse_image_format_properties *
		p_properties) __asm("vkGetPhysicalDeviceSparseImageFormatProperties");

VKAPI_ATTR vk_result VKAPI_CALL
vk_queue_bind_sparse(vk_queue queue, uint32_t bind_info_count,
		     const vk_bind_sparse_info *p_bind_info,
		     vk_fence fence) __asm("vkQueueBindSparse");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_fence(vk_device device, const vk_fence_create_info *p_create_info,
		const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_reset_fences(vk_device device, uint32_t fence_count,
		const vk_fence *p_fences) __asm("vkResetFences");

VKAPI_ATTR vk_result VKAPI_CALL
vk_get_fence_status(vk_device device, vk_fence fence) __asm("vkGetFenceStatus");

VKAPI_ATTR vk_result VKAPI_CALL vk_wait_for_fences(
	vk_device device, uint32_t fence_count, const vk_fence *p_fences,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_event(vk_device device, const vk_event_create_info *p_create_info,
		const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_get_event_status(vk_device device, vk_event event) __asm("vkGetEventStatus");

VKAPI_ATTR vk_result VKAPI_CALL
vk_set_event(vk_device device, vk_event event) __asm("vkSetEvent");

VKAPI_ATTR vk_result VKAPI_CALL
vk_reset_event(vk_device device, vk_event event) __asm("vkResetEvent");
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_buffer(vk_device device, const vk_buffer_create_info *p_create_info,
		 const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_create_image(vk_device device, const vk_image_create_info *p_create_info,
		const vk_allocation_callbacks *p_allocator,
...
vk_destroy_shader_module(vk_device device, vk_shader_module shader_module,
			 const vk_allocation_callbacks
				 *p_allocator) __asm("vkDestroyShaderModule");
...
vk_destroy_pipeline_cache(vk_device device, vk_pipeline_cache pipeline_cache,
			  const vk_allocation_callbacks
				  *p_allocator) __asm("vkDestroyPipelineCache");
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_pipeline_layout(
	vk_device device, vk_pipeline_layout pipeline_layout,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyPipelineLayout");

VKAPI_ATTR vk_result VKAPI_CALL
vk_create_sampler(vk_device device, const vk_sampler_create_info *p_create_info,
		  const vk_allocation_callbacks *p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_descriptor_set_layout(
	...
	vk_descriptor_set_layout
		*p_set_layout) __asm("vkCreateDescriptorSetLayout");

VKAPI_ATTR void VKAPI_CALL vk_destroy_descriptor_set_layout(
	vk_device device, vk_descriptor_set_layout descriptor_set_layout,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyDescriptorSetLayout");
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_descriptor_pool(
	vk_device device, vk_descriptor_pool descriptor_pool,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyDescriptorPool");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_free_descriptor_sets(
	vk_device device, vk_descriptor_pool descriptor_pool,
	uint32_t descriptor_set_count,
	const vk_descriptor_set
		*p_descriptor_sets) __asm("vkFreeDescriptorSets");

VKAPI_ATTR void VKAPI_CALL vk_update_descriptor_sets(
	vk_device device, uint32_t descriptor_write_count,
	const vk_write_descriptor_set *p_descriptor_writes,
	uint32_t descriptor_copy_count,
	const vk_copy_descriptor_set
		*p_descriptor_copies) __asm("vkUpdateDescriptorSets");
...
vk_destroy_framebuffer(vk_device device, vk_framebuffer framebuffer,
		       const vk_allocation_callbacks
			       *p_allocator) __asm("vkDestroyFramebuffer");
...
vk_destroy_command_pool(vk_device device, vk_command_pool command_pool,
			const vk_allocation_callbacks
				*p_allocator) __asm("vkDestroyCommandPool");
...
VKAPI_ATTR void VKAPI_CALL vk_free_command_buffers(
	vk_device device, vk_command_pool command_pool,
	uint32_t command_buffer_count,
	const vk_command_buffer
		*p_command_buffers) __asm("vkFreeCommandBuffers");

VKAPI_ATTR vk_result VKAPI_CALL
vk_begin_command_buffer(vk_command_buffer command_buffer,
			const vk_command_buffer_begin_info
				*p_begin_info) __asm("vkBeginCommandBuffer");
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_bind_pipeline(vk_command_buffer command_buffer,
		     vk_pipeline_bind_point pipeline_bind_point,
		     vk_pipeline pipeline) __asm("vkCmdBindPipeline");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_viewport(vk_command_buffer command_buffer, uint32_t first_viewport,
		    uint32_t viewport_count,
		    const vk_viewport *p_viewports) __asm("vkCmdSetViewport");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_scissor(vk_command_buffer command_buffer, uint32_t first_scissor,
		   uint32_t scissor_count,
		   const vk_rect2d *p_scissors) __asm("vkCmdSetScissor");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_line_width(vk_command_buffer command_buffer,
		      float line_width) __asm("vkCmdSetLineWidth");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_depth_bias(vk_command_buffer command_buffer,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_draw(vk_command_buffer command_buffer, uint32_t vertex_count,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_draw_indirect(vk_command_buffer command_buffer, vk_buffer buffer,
		     vk_device_size offset, uint32_t draw_count,
		     uint32_t stride) __asm("vkCmdDrawIndirect");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_draw_indexed_indirect(vk_command_buffer command_buffer, vk_buffer buffer,
			     vk_device_size offset, uint32_t draw_count,
			     uint32_t stride) __asm("vkCmdDrawIndexedIndirect");

VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch(
	vk_command_buffer command_buffer, uint32_t group_count_x,
	uint32_t group_count_y, uint32_t group_count_z) __asm("vkCmdDispatch");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_dispatch_indirect(vk_command_buffer command_buffer, vk_buffer buffer,
			 vk_device_size offset) __asm("vkCmdDispatchIndirect");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_copy_buffer(vk_command_buffer command_buffer, vk_buffer src_buffer,
		   vk_buffer dst_buffer, uint32_t region_count,
		   const vk_buffer_copy *p_regions) __asm("vkCmdCopyBuffer");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_copy_image(vk_command_buffer command_buffer, vk_image src_image,
		  vk_image_layout src_image_layout, vk_image dst_image,
		  vk_image_layout dst_image_layout, uint32_t region_count,
		  const vk_image_copy *p_regions) __asm("vkCmdCopyImage");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_blit_image(vk_command_buffer command_buffer, vk_image src_image,
		  vk_image_layout src_image_layout, vk_image dst_image,
		  vk_image_layout dst_image_layout, uint32_t region_count,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_update_buffer(vk_command_buffer command_buffer, vk_buffer dst_buffer,
		     vk_device_size dst_offset, vk_device_size data_size,
		     const void *p_data) __asm("vkCmdUpdateBuffer");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_fill_buffer(vk_command_buffer command_buffer, vk_buffer dst_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_clear_color_image(
	...
	const vk_image_subresource_range
		*p_ranges) __asm("vkCmdClearColorImage");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_clear_depth_stencil_image(
	...
	uint32_t range_count,
	const vk_image_subresource_range
		*p_ranges) __asm("vkCmdClearDepthStencilImage");
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_event(vk_command_buffer command_buffer, vk_event event,
		 vk_pipeline_stage_flags stage_mask) __asm("vkCmdSetEvent");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_reset_event(vk_command_buffer command_buffer, vk_event event,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_wait_events(
	...
	const vk_buffer_memory_barrier *p_buffer_memory_barriers,
	uint32_t image_memory_barrier_count,
	const vk_image_memory_barrier
		*p_image_memory_barriers) __asm("vkCmdWaitEvents");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_pipeline_barrier(
	...
	uint32_t image_memory_barrier_count,
	const vk_image_memory_barrier
		*p_image_memory_barriers) __asm("vkCmdPipelineBarrier");
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_end_query(vk_command_buffer command_buffer, vk_query_pool query_pool,
		 uint32_t query) __asm("vkCmdEndQuery");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_reset_query_pool(vk_command_buffer command_buffer,
			vk_query_pool query_pool, uint32_t first_query,
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_next_subpass(vk_command_buffer command_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_execute_commands(
	vk_command_buffer command_buffer, uint32_t command_buffer_count,
	const vk_command_buffer
		*p_command_buffers) __asm("vkCmdExecuteCommands");
#endif
...
typedef vk_physical_device_variable_pointers_features
	vk_physical_device_variable_pointer_features;
...
typedef struct vk_external_semaphore_properties {
	vk_structure_type s_type;
	void *p_next;
	vk_external_semaphore_handle_type_flags
...
typedef vk_physical_device_shader_draw_parameters_features
	vk_physical_device_shader_draw_parameter_features;

typedef vk_result(VKAPI_PTR *pfn_vk_enumerate_instance_version)(
	uint32_t *p_api_version);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_buffer_memory2)(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_buffer_memory_info *p_bind_infos);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_image_memory2)(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_image_memory_info *p_bind_infos);
typedef void(VKAPI_PTR *pfn_vk_get_device_group_peer_memory_features)(
	vk_device device, uint32_t heap_index, uint32_t local_device_index,
	uint32_t remote_device_index,
	vk_peer_memory_feature_flags *p_peer_memory_features);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_device_mask)(
	vk_command_buffer command_buffer, uint32_t device_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch_base)(
	vk_command_buffer command_buffer, uint32_t base_group_x,
...
typedef void(VKAPI_PTR *pfn_vk_get_image_memory_requirements2)(
	vk_device device, const vk_image_memory_requirements_info2 *p_info,
	vk_memory_requirements2 *p_memory_requirements);
typedef void(VKAPI_PTR *pfn_vk_get_buffer_memory_requirements2)(
...
typedef void(VKAPI_PTR *pfn_vk_get_image_sparse_memory_requirements2)(
	...
	uint32_t *p_sparse_memory_requirement_count,
	vk_sparse_image_memory_requirements2 *p_sparse_memory_requirements);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_features2)(
	vk_physical_device physical_device,
	vk_physical_device_features2 *p_features);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_properties2)(
	vk_physical_device physical_device,
	vk_physical_device_properties2 *p_properties);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_format_properties2)(
	vk_physical_device physical_device, vk_format format,
	vk_format_properties2 *p_format_properties);
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties2)(
	vk_physical_device physical_device,
...
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_memory_properties2)(
	vk_physical_device physical_device,
	vk_physical_device_memory_properties2 *p_memory_properties);
typedef void(
	VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties2)(
	vk_physical_device physical_device,
	const vk_physical_device_sparse_image_format_info2 *p_format_info,
	uint32_t *p_property_count,
	vk_sparse_image_format_properties2 *p_properties);
typedef void(VKAPI_PTR *pfn_vk_trim_command_pool)(
	vk_device device, vk_command_pool command_pool,
	vk_command_pool_trim_flags flags);
typedef void(VKAPI_PTR *pfn_vk_get_device_queue2)(
	vk_device device, const vk_device_queue_info2 *p_queue_info,
	vk_queue *p_queue);
typedef vk_result(VKAPI_PTR *pfn_vk_create_sampler_ycbcr_conversion)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_sampler_ycbcr_conversion *p_ycbcr_conversion);
typedef void(VKAPI_PTR *pfn_vk_destroy_sampler_ycbcr_conversion)(
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_descriptor_update_template)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_descriptor_update_template *p_descriptor_update_template);
...
typedef void(VKAPI_PTR *pfn_vk_update_descriptor_set_with_template)(
	vk_device device, vk_descriptor_set descriptor_set,
	vk_descriptor_update_template descriptor_update_template,
	const void *p_data);
...
typedef void(
	VKAPI_PTR *pfn_vk_get_physical_device_external_semaphore_properties)(
	vk_physical_device physical_device,
	const vk_physical_device_external_semaphore_info
...
vk_bind_buffer_memory2(vk_device device, uint32_t bind_info_count,
		       const vk_bind_buffer_memory_info
			       *p_bind_infos) __asm("vkBindBufferMemory2");

VKAPI_ATTR vk_result VKAPI_CALL
vk_bind_image_memory2(vk_device device, uint32_t bind_info_count,
		      const vk_bind_image_memory_info
			      *p_bind_infos) __asm("vkBindImageMemory2");

VKAPI_ATTR void VKAPI_CALL vk_get_device_group_peer_memory_features(
	vk_device device, uint32_t heap_index, uint32_t local_device_index,
	uint32_t remote_device_index,
	vk_peer_memory_feature_flags *
		p_peer_memory_features) __asm("vkGetDeviceGroupPeerMemoryFeatures");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_device_mask(vk_command_buffer command_buffer,
		       uint32_t device_mask) __asm("vkCmdSetDeviceMask");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_dispatch_base(vk_command_buffer command_buffer, uint32_t base_group_x,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_physical_device_groups(
	vk_instance instance, uint32_t *p_physical_device_group_count,
	vk_physical_device_group_properties *
		p_physical_device_group_properties) __asm("vkEnumeratePhysicalDeviceGroups");

VKAPI_ATTR void VKAPI_CALL vk_get_image_memory_requirements2(
	vk_device device, const vk_image_memory_requirements_info2 *p_info,
	vk_memory_requirements2
		*p_memory_requirements) __asm("vkGetImageMemoryRequirements2");

VKAPI_ATTR void VKAPI_CALL vk_get_buffer_memory_requirements2(
	vk_device device, const vk_buffer_memory_requirements_info2 *p_info,
	vk_memory_requirements2
		*p_memory_requirements) __asm("vkGetBufferMemoryRequirements2");
...
VKAPI_ATTR void VKAPI_CALL vk_get_image_sparse_memory_requirements2(
	...
	uint32_t *p_sparse_memory_requirement_count,
	vk_sparse_image_memory_requirements2 *
		p_sparse_memory_requirements) __asm("vkGetImageSparseMemoryRequirements2");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_features2(
	vk_physical_device physical_device,
	vk_physical_device_features2
		*p_features) __asm("vkGetPhysicalDeviceFeatures2");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_properties2(
	vk_physical_device physical_device,
	vk_physical_device_properties2
		*p_properties) __asm("vkGetPhysicalDeviceProperties2");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_format_properties2(
	vk_physical_device physical_device, vk_format format,
	vk_format_properties2 *
		p_format_properties) __asm("vkGetPhysicalDeviceFormatProperties2");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_image_format_properties2(
	vk_physical_device physical_device,
	const vk_physical_device_image_format_info2 *p_image_format_info,
	vk_image_format_properties2 *
		p_image_format_properties) __asm("vkGetPhysicalDeviceImageFormatProperties2");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_queue_family_properties2(
	vk_physical_device physical_device,
	uint32_t *p_queue_family_property_count,
	vk_queue_family_properties2 *
		p_queue_family_properties) __asm("vkGetPhysicalDeviceQueueFamilyProperties2");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_memory_properties2(
	vk_physical_device physical_device,
	vk_physical_device_memory_properties2 *
		p_memory_properties) __asm("vkGetPhysicalDeviceMemoryProperties2");
...
vk_get_physical_device_sparse_image_format_properties2(
	...
	uint32_t *p_property_count,
	vk_sparse_image_format_properties2 *
		p_properties) __asm("vkGetPhysicalDeviceSparseImageFormatProperties2");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_sampler_ycbcr_conversion(
	...
	vk_sampler_ycbcr_conversion
		*p_ycbcr_conversion) __asm("vkCreateSamplerYcbcrConversion");

VKAPI_ATTR void VKAPI_CALL vk_destroy_sampler_ycbcr_conversion(
	vk_device device, vk_sampler_ycbcr_conversion ycbcr_conversion,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroySamplerYcbcrConversion");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_descriptor_update_template(
	...
	vk_descriptor_update_template *
		p_descriptor_update_template) __asm("vkCreateDescriptorUpdateTemplate");

VKAPI_ATTR void VKAPI_CALL vk_destroy_descriptor_update_template(
	vk_device device,
	vk_descriptor_update_template descriptor_update_template,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyDescriptorUpdateTemplate");
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_buffer_properties(
	...
	const vk_physical_device_external_buffer_info *p_external_buffer_info,
	vk_external_buffer_properties *
		p_external_buffer_properties) __asm("vkGetPhysicalDeviceExternalBufferProperties");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_fence_properties(
	vk_physical_device physical_device,
	const vk_physical_device_external_fence_info *p_external_fence_info,
	vk_external_fence_properties *
		p_external_fence_properties) __asm("vkGetPhysicalDeviceExternalFenceProperties");
...
VKAPI_ATTR void VKAPI_CALL vk_get_descriptor_set_layout_support(
	...
	const vk_descriptor_set_layout_create_info *p_create_info,
	vk_descriptor_set_layout_support
		*p_support) __asm("vkGetDescriptorSetLayoutSupport");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_count)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
typedef vk_result(VKAPI_PTR *pfn_vk_create_render_pass2)(
	vk_device device, const vk_render_pass_create_info2 *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_render_pass *p_render_pass);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_render_pass2)(
	vk_command_buffer command_buffer,
	const vk_render_pass_begin_info *p_render_pass_begin,
	const vk_subpass_begin_info *p_subpass_begin_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_next_subpass2)(
	vk_command_buffer command_buffer,
	const vk_subpass_begin_info *p_subpass_begin_info,
	const vk_subpass_end_info *p_subpass_end_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_render_pass2)(
	vk_command_buffer command_buffer,
	const vk_subpass_end_info *p_subpass_end_info);
typedef void(VKAPI_PTR *pfn_vk_reset_query_pool)(vk_device device,
						 vk_query_pool query_pool,
						 uint32_t first_query,
						 uint32_t query_count);
typedef vk_result(VKAPI_PTR *pfn_vk_get_semaphore_counter_value)(
	vk_device device, vk_semaphore semaphore, uint64_t *p_value);
typedef vk_result(VKAPI_PTR *pfn_vk_wait_semaphores)(
	vk_device device, const vk_semaphore_wait_info *p_wait_info,
	uint64_t timeout);
typedef vk_result(VKAPI_PTR *pfn_vk_signal_semaphore)(
	vk_device device, const vk_semaphore_signal_info *p_signal_info);
typedef vk_device_address(VKAPI_PTR *pfn_vk_get_buffer_device_address)(
	vk_device device, const vk_buffer_device_address_info *p_info);
typedef uint64_t(VKAPI_PTR *pfn_vk_get_buffer_opaque_capture_address)(
	vk_device device, const vk_buffer_device_address_info *p_info);
typedef uint64_t(VKAPI_PTR *pfn_vk_get_device_memory_opaque_capture_address)(
	vk_device device,
	const vk_device_memory_opaque_capture_address_info *p_info);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_render_pass2(
	vk_command_buffer command_buffer,
	const vk_render_pass_begin_info *p_render_pass_begin,
	const vk_subpass_begin_info
		*p_subpass_begin_info) __asm("vkCmdBeginRenderPass2");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_next_subpass2(vk_command_buffer command_buffer,
		     const vk_subpass_begin_info *p_subpass_begin_info,
		     const vk_subpass_end_info
			     *p_subpass_end_info) __asm("vkCmdNextSubpass2");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_render_pass2(
	vk_command_buffer command_buffer,
	const vk_subpass_end_info
		*p_subpass_end_info) __asm("vkCmdEndRenderPass2");
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_wait_semaphores(vk_device device, const vk_semaphore_wait_info *p_wait_info,
		   uint64_t timeout) __asm("vkWaitSemaphores");

VKAPI_ATTR vk_result VKAPI_CALL vk_signal_semaphore(
	vk_device device, const vk_semaphore_signal_info
				  *p_signal_info) __asm("vkSignalSemaphore");

VKAPI_ATTR vk_device_address VKAPI_CALL vk_get_buffer_device_address(
	vk_device device, const vk_buffer_device_address_info
				  *p_info) __asm("vkGetBufferDeviceAddress");

VKAPI_ATTR uint64_t VKAPI_CALL vk_get_buffer_opaque_capture_address(
	vk_device device,
	const vk_buffer_device_address_info
		*p_info) __asm("vkGetBufferOpaqueCaptureAddress");

VKAPI_ATTR uint64_t VKAPI_CALL vk_get_device_memory_opaque_capture_address(
	vk_device device,
	const vk_device_memory_opaque_capture_address_info
		*p_info) __asm("vkGetDeviceMemoryOpaqueCaptureAddress");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_destroy_surface_khr)(
	vk_instance instance, vk_surface_khr surface,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_surface_support_khr)(
	vk_physical_device physical_device, uint32_t queue_family_index,
	vk_surface_khr surface, vk_bool32 *p_supported);
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_surface_capabilities_khr)(
	vk_physical_device physical_device, vk_surface_khr surface,
	vk_surface_capabilities_khr *p_surface_capabilities);
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_surface_formats_khr)(
	vk_physical_device physical_device, vk_surface_khr surface,
	uint32_t *p_surface_format_count,
	vk_surface_format_khr *p_surface_formats);
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_surface_present_modes_khr)(
	vk_physical_device physical_device, vk_surface_khr surface,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_surface_capabilities_khr(
	vk_physical_device physical_device, vk_surface_khr surface,
	vk_surface_capabilities_khr *
		p_surface_capabilities) __asm("vkGetPhysicalDeviceSurfaceCapabilitiesKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_surface_formats_khr(
	vk_physical_device physical_device, vk_surface_khr surface,
	uint32_t *p_surface_format_count,
	vk_surface_format_khr *
		p_surface_formats) __asm("vkGetPhysicalDeviceSurfaceFormatsKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_surface_present_modes_khr(
	vk_physical_device physical_device, vk_surface_khr surface,
	uint32_t *p_present_mode_count,
	vk_present_mode_khr *
		p_present_modes) __asm("vkGetPhysicalDeviceSurfacePresentModesKHR");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_swapchain_khr)(
	vk_device device, const vk_swapchain_create_info_khr *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_swapchain_khr *p_swapchain);
typedef void(VKAPI_PTR *pfn_vk_destroy_swapchain_khr)(
	vk_device device, vk_swapchain_khr swapchain,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_get_swapchain_images_khr)(
	vk_device device, vk_swapchain_khr swapchain,
	uint32_t *p_swapchain_image_count, vk_image *p_swapchain_images);
typedef vk_result(VKAPI_PTR *pfn_vk_acquire_next_image_khr)(
	vk_device device, vk_swapchain_khr swapchain, uint64_t timeout,
	vk_semaphore semaphore, vk_fence fence, uint32_t *p_image_index);
typedef vk_result(VKAPI_PTR *pfn_vk_queue_present_khr)(
	vk_queue queue, const vk_present_info_khr *p_present_info);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_present_rectangles_khr)(
	vk_physical_device physical_device, vk_surface_khr surface,
	uint32_t *p_rect_count, vk_rect2d *p_rects);
typedef vk_result(VKAPI_PTR *pfn_vk_acquire_next_image2khr)(
	vk_device device, const vk_acquire_next_image_info_khr *p_acquire_info,
...
vk_destroy_swapchain_khr(vk_device device, vk_swapchain_khr swapchain,
			 const vk_allocation_callbacks
				 *p_allocator) __asm("vkDestroySwapchainKHR");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_next_image_khr(
	vk_device device, vk_swapchain_khr swapchain, uint64_t timeout,
	vk_semaphore semaphore, vk_fence fence,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_device_group_surface_present_modes_khr(
	...
	vk_device_group_present_mode_flags_khr
		*p_modes) __asm("vkGetDeviceGroupSurfacePresentModesKHR");
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_display_properties_khr)(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_properties_khr *p_properties);
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_display_plane_properties_khr)(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_plane_properties_khr *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_get_display_plane_supported_displays_khr)(
	vk_physical_device physical_device, uint32_t plane_index,
	uint32_t *p_display_count, vk_display_khr *p_displays);
typedef vk_result(VKAPI_PTR *pfn_vk_get_display_mode_properties_khr)(
	vk_physical_device physical_device, vk_display_khr display,
	uint32_t *p_property_count,
	vk_display_mode_properties_khr *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_create_display_mode_khr)(
	vk_physical_device physical_device, vk_display_khr display,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_display_plane_capabilities_khr)(
	vk_physical_device physical_device, vk_display_mode_khr mode,
	uint32_t plane_index,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_display_properties_khr(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_properties_khr
		*p_properties) __asm("vkGetPhysicalDeviceDisplayPropertiesKHR");

VKAPI_ATTR vk_result VKAPI_CALL
vk_get_physical_device_display_plane_properties_khr(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_plane_properties_khr *
		p_properties) __asm("vkGetPhysicalDeviceDisplayPlanePropertiesKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_display_plane_supported_displays_khr(
	vk_physical_device physical_device, uint32_t plane_index,
	uint32_t *p_display_count,
	vk_display_khr
		*p_displays) __asm("vkGetDisplayPlaneSupportedDisplaysKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_display_mode_properties_khr(
	vk_physical_device physical_device, vk_display_khr display,
	uint32_t *p_property_count,
	vk_display_mode_properties_khr
		*p_properties) __asm("vkGetDisplayModePropertiesKHR");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_display_plane_capabilities_khr(
	...
	uint32_t plane_index,
	vk_display_plane_capabilities_khr
		*p_capabilities) __asm("vkGetDisplayPlaneCapabilitiesKHR");
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_shared_swapchains_khr)(
	vk_device device, uint32_t swapchain_count,
...
typedef vk_render_pass_multiview_create_info
	vk_render_pass_multiview_create_info_khr;

typedef vk_physical_device_multiview_features
	vk_physical_device_multiview_features_khr;

typedef vk_physical_device_multiview_properties
	vk_physical_device_multiview_properties_khr;
...
typedef vk_physical_device_image_format_info2
	vk_physical_device_image_format_info2khr;

typedef vk_queue_family_properties2 vk_queue_family_properties2khr;

typedef vk_physical_device_memory_properties2
	vk_physical_device_memory_properties2khr;

typedef vk_sparse_image_format_properties2 vk_sparse_image_format_properties2khr;

typedef vk_physical_device_sparse_image_format_info2
	vk_physical_device_sparse_image_format_info2khr;

typedef void(VKAPI_PTR *pfn_vk_get_physical_device_features2khr)(
	vk_physical_device physical_device,
	vk_physical_device_features2 *p_features);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_properties2khr)(
	vk_physical_device physical_device,
	vk_physical_device_properties2 *p_properties);
typedef void(VKAPI_PTR *pfn_vk_get_physical_device_format_properties2khr)(
	vk_physical_device physical_device, vk_format format,
	vk_format_properties2 *p_format_properties);
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties2khr)(
	vk_physical_device physical_device,
	const vk_physical_device_image_format_info2 *p_image_format_info,
	vk_image_format_properties2 *p_image_format_properties);
...
typedef void(
	VKAPI_PTR
		*pfn_vk_get_physical_device_sparse_image_format_properties2khr)(
	vk_physical_device physical_device,
	const vk_physical_device_sparse_image_format_info2 *p_format_info,
	uint32_t *p_property_count,
	vk_sparse_image_format_properties2 *p_properties);
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_features2khr(
	vk_physical_device physical_device,
	vk_physical_device_features2
		*p_features) __asm("vkGetPhysicalDeviceFeatures2KHR");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_properties2khr(
	vk_physical_device physical_device,
	vk_physical_device_properties2
		*p_properties) __asm("vkGetPhysicalDeviceProperties2KHR");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_format_properties2khr(
	vk_physical_device physical_device, vk_format format,
	vk_format_properties2 *
		p_format_properties) __asm("vkGetPhysicalDeviceFormatProperties2KHR");

VKAPI_ATTR vk_result VKAPI_CALL
vk_get_physical_device_image_format_properties2khr(
	vk_physical_device physical_device,
	const vk_physical_device_image_format_info2 *p_image_format_info,
	vk_image_format_properties2 *
		p_image_format_properties) __asm("vkGetPhysicalDeviceImageFormatProperties2KHR");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_queue_family_properties2khr(
	vk_physical_device physical_device,
	uint32_t *p_queue_family_property_count,
	vk_queue_family_properties2 *
		p_queue_family_properties) __asm("vkGetPhysicalDeviceQueueFamilyProperties2KHR");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_memory_properties2khr(
	vk_physical_device physical_device,
	vk_physical_device_memory_properties2 *
		p_memory_properties) __asm("vkGetPhysicalDeviceMemoryProperties2KHR");

VKAPI_ATTR void VKAPI_CALL
vk_get_physical_device_sparse_image_format_properties2khr(
	vk_physical_device physical_device,
	const vk_physical_device_sparse_image_format_info2 *p_format_info,
	uint32_t *p_property_count,
	vk_sparse_image_format_properties2 *
		p_properties) __asm("vkGetPhysicalDeviceSparseImageFormatProperties2KHR");
#endif
...
typedef vk_device_group_render_pass_begin_info
	vk_device_group_render_pass_begin_info_khr;

typedef vk_device_group_command_buffer_begin_info
	vk_device_group_command_buffer_begin_info_khr;
...
typedef vk_bind_buffer_memory_device_group_info
	vk_bind_buffer_memory_device_group_info_khr;

typedef vk_bind_image_memory_device_group_info
	vk_bind_image_memory_device_group_info_khr;

typedef void(VKAPI_PTR *pfn_vk_get_device_group_peer_memory_features_khr)(
	vk_device device, uint32_t heap_index, uint32_t local_device_index,
	uint32_t remote_device_index,
	vk_peer_memory_feature_flags *p_peer_memory_features);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_device_mask_khr)(
	vk_command_buffer command_buffer, uint32_t device_mask);
typedef void(VKAPI_PTR *pfn_vk_cmd_dispatch_base_khr)(
	vk_command_buffer command_buffer, uint32_t base_group_x,
	uint32_t base_group_y, uint32_t base_group_z, uint32_t group_count_x,
	uint32_t group_count_y, uint32_t group_count_z);
...
VKAPI_ATTR void VKAPI_CALL vk_get_device_group_peer_memory_features_khr(
	...
	uint32_t remote_device_index,
	vk_peer_memory_feature_flags *
		p_peer_memory_features) __asm("vkGetDeviceGroupPeerMemoryFeaturesKHR");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_set_device_mask_khr(vk_command_buffer command_buffer,
...
typedef void(VKAPI_PTR *pfn_vk_trim_command_pool_khr)(
	vk_device device, vk_command_pool command_pool,
	vk_command_pool_trim_flags flags);
...
typedef vk_physical_device_group_properties
	vk_physical_device_group_properties_khr;

typedef vk_device_group_device_create_info
	vk_device_group_device_create_info_khr;
...
typedef vk_external_memory_handle_type_flags
	vk_external_memory_handle_type_flags_khr;

typedef vk_external_memory_handle_type_flag_bits
	vk_external_memory_handle_type_flag_bits_khr;

typedef vk_external_memory_feature_flags vk_external_memory_feature_flags_khr;

typedef vk_external_memory_feature_flag_bits
	vk_external_memory_feature_flag_bits_khr;

typedef vk_external_memory_properties vk_external_memory_properties_khr;

typedef vk_physical_device_external_image_format_info
	vk_physical_device_external_image_format_info_khr;

typedef vk_external_image_format_properties
	vk_external_image_format_properties_khr;

typedef vk_physical_device_external_buffer_info
	vk_physical_device_external_buffer_info_khr;
...
typedef void(
	VKAPI_PTR *pfn_vk_get_physical_device_external_buffer_properties_khr)(
	vk_physical_device physical_device,
	const vk_physical_device_external_buffer_info *p_external_buffer_info,
	vk_external_buffer_properties *p_external_buffer_properties);
...
typedef vk_external_memory_image_create_info
	vk_external_memory_image_create_info_khr;

typedef vk_external_memory_buffer_create_info
	vk_external_memory_buffer_create_info_khr;
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_memory_fd_khr)(
	vk_device device, const vk_memory_get_fd_info_khr *p_get_fd_info,
	int *p_fd);
typedef vk_result(VKAPI_PTR *pfn_vk_get_memory_fd_properties_khr)(
	vk_device device, vk_external_memory_handle_type_flag_bits handle_type,
	int fd, vk_memory_fd_properties_khr *p_memory_fd_properties);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_memory_fd_properties_khr(
	...
	int fd,
	vk_memory_fd_properties_khr
		*p_memory_fd_properties) __asm("vkGetMemoryFdPropertiesKHR");
#endif
...
typedef vk_external_semaphore_handle_type_flags
	vk_external_semaphore_handle_type_flags_khr;

typedef vk_external_semaphore_handle_type_flag_bits
	vk_external_semaphore_handle_type_flag_bits_khr;

typedef vk_external_semaphore_feature_flags
	vk_external_semaphore_feature_flags_khr;

typedef vk_external_semaphore_feature_flag_bits
	vk_external_semaphore_feature_flag_bits_khr;

typedef vk_physical_device_external_semaphore_info
	vk_physical_device_external_semaphore_info_khr;

typedef vk_external_semaphore_properties vk_external_semaphore_properties_khr;

typedef void(
	VKAPI_PTR *pfn_vk_get_physical_device_external_semaphore_properties_khr)(
	vk_physical_device physical_device,
	const vk_physical_device_external_semaphore_info
		*p_external_semaphore_info,
	vk_external_semaphore_properties *p_external_semaphore_properties);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_get_physical_device_external_semaphore_properties_khr(
	vk_physical_device physical_device,
	const vk_physical_device_external_semaphore_info
		*p_external_semaphore_info,
	vk_external_semaphore_properties *
...
typedef vk_result(VKAPI_PTR *pfn_vk_import_semaphore_fd_khr)(
	vk_device device,
	const vk_import_semaphore_fd_info_khr *p_import_semaphore_fd_info);
typedef vk_result(VKAPI_PTR *pfn_vk_get_semaphore_fd_khr)(
	vk_device device, const vk_semaphore_get_fd_info_khr *p_get_fd_info,
	int *p_fd);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_import_semaphore_fd_khr(
	vk_device device,
	const vk_import_semaphore_fd_info_khr
		*p_import_semaphore_fd_info) __asm("vkImportSemaphoreFdKHR");
...
typedef void(VKAPI_PTR *pfn_vk_cmd_push_descriptor_set_khr)(
	vk_command_buffer command_buffer,
	vk_pipeline_bind_point pipeline_bind_point, vk_pipeline_layout layout,
	uint32_t set, uint32_t descriptor_write_count,
	const vk_write_descriptor_set *p_descriptor_writes);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_push_descriptor_set_khr(
	...
	vk_pipeline_bind_point pipeline_bind_point, vk_pipeline_layout layout,
	uint32_t set, uint32_t descriptor_write_count,
	const vk_write_descriptor_set
		*p_descriptor_writes) __asm("vkCmdPushDescriptorSetKHR");
...
typedef vk_physical_device_shader_float16int8features
	vk_physical_device_shader_float16int8features_khr;

typedef vk_physical_device_shader_float16int8features
	vk_physical_device_float16int8features_khr;

#define vk_khr_16bit_storage 1
#define VK_KHR_16BIT_STORAGE_SPEC_VERSION 1
#define VK_KHR_16BIT_STORAGE_EXTENSION_NAME "VK_KHR_16bit_storage"
typedef vk_physical_device16bit_storage_features
	vk_physical_device16bit_storage_features_khr;
...
typedef vk_descriptor_update_template_type
	vk_descriptor_update_template_type_khr;

typedef vk_descriptor_update_template_create_flags
	vk_descriptor_update_template_create_flags_khr;

typedef vk_descriptor_update_template_entry
	vk_descriptor_update_template_entry_khr;

typedef vk_descriptor_update_template_create_info
	vk_descriptor_update_template_create_info_khr;
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_descriptor_update_template_khr(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_descriptor_update_template *
		p_descriptor_update_template) __asm("vkCreateDescriptorUpdateTemplateKHR");

VKAPI_ATTR void VKAPI_CALL vk_destroy_descriptor_update_template_khr(
	vk_device device,
	vk_descriptor_update_template descriptor_update_template,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyDescriptorUpdateTemplateKHR");
...
typedef vk_physical_device_imageless_framebuffer_features
	vk_physical_device_imageless_framebuffer_features_khr;

typedef vk_framebuffer_attachments_create_info
	vk_framebuffer_attachments_create_info_khr;

typedef vk_framebuffer_attachment_image_info
	vk_framebuffer_attachment_image_info_khr;

typedef vk_render_pass_attachment_begin_info
	vk_render_pass_attachment_begin_info_khr;
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_render_pass2khr)(
	vk_device device, const vk_render_pass_create_info2 *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_render_pass *p_render_pass);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_render_pass2khr)(
	vk_command_buffer command_buffer,
	const vk_render_pass_begin_info *p_render_pass_begin,
	const vk_subpass_begin_info *p_subpass_begin_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_next_subpass2khr)(
	vk_command_buffer command_buffer,
	const vk_subpass_begin_info *p_subpass_begin_info,
	const vk_subpass_end_info *p_subpass_end_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_render_pass2khr)(
	vk_command_buffer command_buffer,
	const vk_subpass_end_info *p_subpass_end_info);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_render_pass2khr(
	...
	const vk_render_pass_begin_info *p_render_pass_begin,
	const vk_subpass_begin_info
		*p_subpass_begin_info) __asm("vkCmdBeginRenderPass2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_next_subpass2khr(
	vk_command_buffer command_buffer,
	const vk_subpass_begin_info *p_subpass_begin_info,
	const vk_subpass_end_info
		*p_subpass_end_info) __asm("vkCmdNextSubpass2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_render_pass2khr(
	vk_command_buffer command_buffer,
	const vk_subpass_end_info
		*p_subpass_end_info) __asm("vkCmdEndRenderPass2KHR");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_swapchain_status_khr)(
	vk_device device, vk_swapchain_khr swapchain);
...
typedef vk_external_fence_handle_type_flags
	vk_external_fence_handle_type_flags_khr;

typedef vk_external_fence_handle_type_flag_bits
	vk_external_fence_handle_type_flag_bits_khr;

typedef vk_external_fence_feature_flags vk_external_fence_feature_flags_khr;

typedef vk_external_fence_feature_flag_bits
	vk_external_fence_feature_flag_bits_khr;

typedef vk_physical_device_external_fence_info
	vk_physical_device_external_fence_info_khr;

typedef vk_external_fence_properties vk_external_fence_properties_khr;

typedef void(
	VKAPI_PTR *pfn_vk_get_physical_device_external_fence_properties_khr)(
	vk_physical_device physical_device,
	const vk_physical_device_external_fence_info *p_external_fence_info,
	vk_external_fence_properties *p_external_fence_properties);
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_fence_properties_khr(
	...
	const vk_physical_device_external_fence_info *p_external_fence_info,
	vk_external_fence_properties *
		p_external_fence_properties) __asm("vkGetPhysicalDeviceExternalFencePropertiesKHR");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_import_fence_fd_khr)(
	vk_device device,
	const vk_import_fence_fd_info_khr *p_import_fence_fd_info);
typedef vk_result(VKAPI_PTR *pfn_vk_get_fence_fd_khr)(
	vk_device device, const vk_fence_get_fd_info_khr *p_get_fd_info,
	int *p_fd);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_import_fence_fd_khr(
	vk_device device,
	const vk_import_fence_fd_info_khr
		*p_import_fence_fd_info) __asm("vkImportFenceFdKHR");
...
typedef vk_result(
	VKAPI_PTR *
		pfn_vk_enumerate_physical_device_queue_family_performance_query_counters_khr)(
	vk_physical_device physical_device, uint32_t queue_family_index,
	uint32_t *p_counter_count, vk_performance_counter_khr *p_counters,
	vk_performance_counter_description_khr *p_counter_descriptions);
typedef void(
	VKAPI_PTR *
		pfn_vk_get_physical_device_queue_family_performance_query_passes_khr)(
	vk_physical_device physical_device,
	const vk_query_pool_performance_create_info_khr
		*p_performance_query_create_info,
	uint32_t *p_num_passes);
typedef vk_result(VKAPI_PTR *pfn_vk_acquire_profiling_lock_khr)(
	vk_device device, const vk_acquire_profiling_lock_info_khr *p_info);
...
vk_get_physical_device_queue_family_performance_query_passes_khr(
	...
	const vk_query_pool_performance_create_info_khr
		*p_performance_query_create_info,
	uint32_t *
		p_num_passes) __asm("vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_profiling_lock_khr(
	vk_device device, const vk_acquire_profiling_lock_info_khr
				  *p_info) __asm("vkAcquireProfilingLockKHR");
...
typedef vk_physical_device_point_clipping_properties
	vk_physical_device_point_clipping_properties_khr;

typedef vk_render_pass_input_attachment_aspect_create_info
	vk_render_pass_input_attachment_aspect_create_info_khr;

typedef vk_input_attachment_aspect_reference
	vk_input_attachment_aspect_reference_khr;
...
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_surface_capabilities2khr)(
	vk_physical_device physical_device,
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_surface_formats2khr)(
	...
	const vk_physical_device_surface_info2khr *p_surface_info,
	uint32_t *p_surface_format_count,
	vk_surface_format2khr *p_surface_formats);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_surface_capabilities2khr(
	...
	const vk_physical_device_surface_info2khr *p_surface_info,
	vk_surface_capabilities2khr *
		p_surface_capabilities) __asm("vkGetPhysicalDeviceSurfaceCapabilities2KHR");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_surface_formats2khr(
	...
	uint32_t *p_surface_format_count,
	vk_surface_format2khr *
		p_surface_formats) __asm("vkGetPhysicalDeviceSurfaceFormats2KHR");
#endif
...
typedef vk_physical_device_variable_pointers_features
	vk_physical_device_variable_pointer_features_khr;

typedef vk_physical_device_variable_pointers_features
	vk_physical_device_variable_pointers_features_khr;
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_physical_device_display_properties2khr)(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_properties2khr *p_properties);
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_display_plane_properties2khr)(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_plane_properties2khr *p_properties);
typedef vk_result(VKAPI_PTR *pfn_vk_get_display_mode_properties2khr)(
	vk_physical_device physical_device, vk_display_khr display,
	uint32_t *p_property_count,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_display_properties2khr(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_properties2khr *
		p_properties) __asm("vkGetPhysicalDeviceDisplayProperties2KHR");

VKAPI_ATTR vk_result VKAPI_CALL
vk_get_physical_device_display_plane_properties2khr(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_display_plane_properties2khr *
		p_properties) __asm("vkGetPhysicalDeviceDisplayPlaneProperties2KHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_display_mode_properties2khr(
	vk_physical_device physical_device, vk_display_khr display,
	uint32_t *p_property_count,
	vk_display_mode_properties2khr
		*p_properties) __asm("vkGetDisplayModeProperties2KHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_display_plane_capabilities2khr(
	vk_physical_device physical_device,
	const vk_display_plane_info2khr *p_display_plane_info,
	vk_display_plane_capabilities2khr
		*p_capabilities) __asm("vkGetDisplayPlaneCapabilities2KHR");
#endif
...
typedef vk_buffer_memory_requirements_info2
	vk_buffer_memory_requirements_info2khr;

typedef vk_image_memory_requirements_info2 vk_image_memory_requirements_info2khr;

typedef vk_image_sparse_memory_requirements_info2
	vk_image_sparse_memory_requirements_info2khr;

typedef vk_memory_requirements2 vk_memory_requirements2khr;

typedef vk_sparse_image_memory_requirements2
	vk_sparse_image_memory_requirements2khr;

typedef void(VKAPI_PTR *pfn_vk_get_image_memory_requirements2khr)(
	vk_device device, const vk_image_memory_requirements_info2 *p_info,
	vk_memory_requirements2 *p_memory_requirements);
typedef void(VKAPI_PTR *pfn_vk_get_buffer_memory_requirements2khr)(
	vk_device device, const vk_buffer_memory_requirements_info2 *p_info,
	vk_memory_requirements2 *p_memory_requirements);
...
VKAPI_ATTR void VKAPI_CALL vk_get_image_memory_requirements2khr(
	vk_device device, const vk_image_memory_requirements_info2 *p_info,
	vk_memory_requirements2 *
		p_memory_requirements) __asm("vkGetImageMemoryRequirements2KHR");

VKAPI_ATTR void VKAPI_CALL vk_get_buffer_memory_requirements2khr(
	vk_device device, const vk_buffer_memory_requirements_info2 *p_info,
	vk_memory_requirements2 *
		p_memory_requirements) __asm("vkGetBufferMemoryRequirements2KHR");
...
VKAPI_ATTR void VKAPI_CALL vk_get_image_sparse_memory_requirements2khr(
	...
	uint32_t *p_sparse_memory_requirement_count,
	vk_sparse_image_memory_requirements2 *
		p_sparse_memory_requirements) __asm("vkGetImageSparseMemoryRequirements2KHR");
#endif
...
typedef vk_sampler_ycbcr_conversion_create_info
	vk_sampler_ycbcr_conversion_create_info_khr;
...
typedef vk_image_plane_memory_requirements_info
	vk_image_plane_memory_requirements_info_khr;

typedef vk_physical_device_sampler_ycbcr_conversion_features
	vk_physical_device_sampler_ycbcr_conversion_features_khr;

typedef vk_sampler_ycbcr_conversion_image_format_properties
	vk_sampler_ycbcr_conversion_image_format_properties_khr;
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_sampler_ycbcr_conversion_khr)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_sampler_ycbcr_conversion *p_ycbcr_conversion);
typedef void(VKAPI_PTR *pfn_vk_destroy_sampler_ycbcr_conversion_khr)(
	vk_device device, vk_sampler_ycbcr_conversion ycbcr_conversion,
	const vk_allocation_callbacks *p_allocator);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_sampler_ycbcr_conversion_khr(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_sampler_ycbcr_conversion
		*p_ycbcr_conversion) __asm("vkCreateSamplerYcbcrConversionKHR");

VKAPI_ATTR void VKAPI_CALL vk_destroy_sampler_ycbcr_conversion_khr(
	vk_device device, vk_sampler_ycbcr_conversion ycbcr_conversion,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroySamplerYcbcrConversionKHR");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_bind_buffer_memory2khr)(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_buffer_memory_info *p_bind_infos);
typedef vk_result(VKAPI_PTR *pfn_vk_bind_image_memory2khr)(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_image_memory_info *p_bind_infos);
...
vk_bind_buffer_memory2khr(vk_device device, uint32_t bind_info_count,
			  const vk_bind_buffer_memory_info *
				  p_bind_infos) __asm("vkBindBufferMemory2KHR");

VKAPI_ATTR vk_result VKAPI_CALL
vk_bind_image_memory2khr(vk_device device, uint32_t bind_info_count,
			 const vk_bind_image_memory_info
				 *p_bind_infos) __asm("vkBindImageMemory2KHR");
#endif

#define vk_khr_maintenance3 1
#define VK_KHR_MAINTENANCE3_SPEC_VERSION 1
#define VK_KHR_MAINTENANCE3_EXTENSION_NAME "VK_KHR_maintenance3"
typedef vk_physical_device_maintenance3properties
	vk_physical_device_maintenance3properties_khr;
...
VKAPI_ATTR void VKAPI_CALL vk_get_descriptor_set_layout_support_khr(
	...
	const vk_descriptor_set_layout_create_info *p_create_info,
	vk_descriptor_set_layout_support
		*p_support) __asm("vkGetDescriptorSetLayoutSupportKHR");
#endif

#define vk_khr_draw_indirect_count 1
#define VK_KHR_DRAW_INDIRECT_COUNT_SPEC_VERSION 1
#define VK_KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME "VK_KHR_draw_indirect_count"
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_count_khr)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count_khr)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
...
typedef vk_physical_device8bit_storage_features
	vk_physical_device8bit_storage_features_khr;

#define vk_khr_shader_atomic_int64 1
#define VK_KHR_SHADER_ATOMIC_INT64_SPEC_VERSION 1
#define VK_KHR_SHADER_ATOMIC_INT64_EXTENSION_NAME "VK_KHR_shader_atomic_int64"
typedef vk_physical_device_shader_atomic_int64features
	vk_physical_device_shader_atomic_int64features_khr;
...
typedef vk_physical_device_driver_properties
	vk_physical_device_driver_properties_khr;

#define vk_khr_shader_float_controls 1
#define VK_KHR_SHADER_FLOAT_CONTROLS_SPEC_VERSION 4
#define VK_KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME \
	"VK_KHR_shader_float_controls"
typedef vk_shader_float_controls_independence
	vk_shader_float_controls_independence_khr;

typedef vk_physical_device_float_controls_properties
	vk_physical_device_float_controls_properties_khr;
...
typedef vk_subpass_description_depth_stencil_resolve
	vk_subpass_description_depth_stencil_resolve_khr;

typedef vk_physical_device_depth_stencil_resolve_properties
	vk_physical_device_depth_stencil_resolve_properties_khr;
...
typedef vk_physical_device_timeline_semaphore_features
	vk_physical_device_timeline_semaphore_features_khr;

typedef vk_physical_device_timeline_semaphore_properties
	vk_physical_device_timeline_semaphore_properties_khr;
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_semaphore_counter_value_khr)(
	vk_device device, vk_semaphore semaphore, uint64_t *p_value);
typedef vk_result(VKAPI_PTR *pfn_vk_wait_semaphores_khr)(
	vk_device device, const vk_semaphore_wait_info *p_wait_info,
	uint64_t timeout);
typedef vk_result(VKAPI_PTR *pfn_vk_signal_semaphore_khr)(
	vk_device device, const vk_semaphore_signal_info *p_signal_info);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_signal_semaphore_khr(
	vk_device device, const vk_semaphore_signal_info
				  *p_signal_info) __asm("vkSignalSemaphoreKHR");
#endif

#define vk_khr_vulkan_memory_model 1
#define VK_KHR_VULKAN_MEMORY_MODEL_SPEC_VERSION 3
#define VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME "VK_KHR_vulkan_memory_model"
typedef vk_physical_device_vulkan_memory_model_features
	vk_physical_device_vulkan_memory_model_features_khr;
...
typedef vk_attachment_reference_stencil_layout
	vk_attachment_reference_stencil_layout_khr;

typedef vk_attachment_description_stencil_layout
	vk_attachment_description_stencil_layout_khr;
...
typedef vk_physical_device_buffer_device_address_features
	vk_physical_device_buffer_device_address_features_khr;

typedef vk_buffer_device_address_info vk_buffer_device_address_info_khr;

typedef vk_buffer_opaque_capture_address_create_info
	vk_buffer_opaque_capture_address_create_info_khr;

typedef vk_memory_opaque_capture_address_allocate_info
	vk_memory_opaque_capture_address_allocate_info_khr;

typedef vk_device_memory_opaque_capture_address_info
	vk_device_memory_opaque_capture_address_info_khr;

typedef vk_device_address(VKAPI_PTR *pfn_vk_get_buffer_device_address_khr)(
	vk_device device, const vk_buffer_device_address_info *p_info);
typedef uint64_t(VKAPI_PTR *pfn_vk_get_buffer_opaque_capture_address_khr)(
	vk_device device, const vk_buffer_device_address_info *p_info);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_pipeline_executable_properties_khr)(
	vk_device device, const vk_pipeline_info_khr *p_pipeline_info,
...
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_pipeline_executable_internal_representations_khr)(
	vk_device device,
	const vk_pipeline_executable_info_khr *p_executable_info,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_pipeline_executable_properties_khr(
	...
	uint32_t *p_executable_count,
	vk_pipeline_executable_properties_khr
		*p_properties) __asm("vkGetPipelineExecutablePropertiesKHR");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_pipeline_executable_statistics_khr(
	...
	uint32_t *p_statistic_count,
	vk_pipeline_executable_statistic_khr
		*p_statistics) __asm("vkGetPipelineExecutableStatisticsKHR");
...
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer2khr)(
	vk_command_buffer command_buffer,
	const vk_copy_buffer_info2khr *p_copy_buffer_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_image2khr)(
	vk_command_buffer command_buffer,
	const vk_copy_image_info2khr *p_copy_image_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_buffer_to_image2khr)(
	vk_command_buffer command_buffer,
	const vk_copy_buffer_to_image_info2khr *p_copy_buffer_to_image_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_image_to_buffer2khr)(
	vk_command_buffer command_buffer,
	const vk_copy_image_to_buffer_info2khr *p_copy_image_to_buffer_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_blit_image2khr)(
	vk_command_buffer command_buffer,
	const vk_blit_image_info2khr *p_blit_image_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_resolve_image2khr)(
	vk_command_buffer command_buffer,
	const vk_resolve_image_info2khr *p_resolve_image_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_cmd_copy_buffer2khr(vk_command_buffer command_buffer,
		       const vk_copy_buffer_info2khr *
			       p_copy_buffer_info) __asm("vkCmdCopyBuffer2KHR");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_copy_image2khr(vk_command_buffer command_buffer,
		      const vk_copy_image_info2khr
			      *p_copy_image_info) __asm("vkCmdCopyImage2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_buffer_to_image2khr(
	vk_command_buffer command_buffer,
	const vk_copy_buffer_to_image_info2khr *
		p_copy_buffer_to_image_info) __asm("vkCmdCopyBufferToImage2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_image_to_buffer2khr(
	vk_command_buffer command_buffer,
	const vk_copy_image_to_buffer_info2khr *
		p_copy_image_to_buffer_info) __asm("vkCmdCopyImageToBuffer2KHR");

VKAPI_ATTR void VKAPI_CALL
vk_cmd_blit_image2khr(vk_command_buffer command_buffer,
		      const vk_blit_image_info2khr
			      *p_blit_image_info) __asm("vkCmdBlitImage2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_resolve_image2khr(
	vk_command_buffer command_buffer,
	const vk_resolve_image_info2khr
		*p_resolve_image_info) __asm("vkCmdResolveImage2KHR");
#endif
...
typedef vk_bool32(VKAPI_PTR *pfn_vk_debug_report_callback_ext)(
	...
	size_t location, int32_t message_code, const char *p_layer_prefix,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_debug_report_callback_ext)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_debug_report_callback_ext *p_callback);
typedef void(VKAPI_PTR *pfn_vk_destroy_debug_report_callback_ext)(
	vk_instance instance, vk_debug_report_callback_ext callback,
	const vk_allocation_callbacks *p_allocator);
typedef void(VKAPI_PTR *pfn_vk_debug_report_message_ext)(
	vk_instance instance, vk_debug_report_flags_ext flags,
	vk_debug_report_object_type_ext object_type, uint64_t object,
	size_t location, int32_t message_code, const char *p_layer_prefix,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_debug_report_callback_ext(
	...
	const vk_debug_report_callback_create_info_ext *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_debug_report_callback_ext
		*p_callback) __asm("vkCreateDebugReportCallbackEXT");

VKAPI_ATTR void VKAPI_CALL vk_destroy_debug_report_callback_ext(
	vk_instance instance, vk_debug_report_callback_ext callback,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyDebugReportCallbackEXT");
...
typedef vk_result(VKAPI_PTR *pfn_vk_debug_marker_set_object_tag_ext)(
	vk_device device,
	const vk_debug_marker_object_tag_info_ext *p_tag_info);
typedef vk_result(VKAPI_PTR *pfn_vk_debug_marker_set_object_name_ext)(
	vk_device device,
	const vk_debug_marker_object_name_info_ext *p_name_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_debug_marker_begin_ext)(
	vk_command_buffer command_buffer,
	const vk_debug_marker_marker_info_ext *p_marker_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_debug_marker_end_ext)(
	vk_command_buffer command_buffer);
typedef void(VKAPI_PTR *pfn_vk_cmd_debug_marker_insert_ext)(
	vk_command_buffer command_buffer,
	const vk_debug_marker_marker_info_ext *p_marker_info);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_debug_marker_set_object_tag_ext(
	vk_device device,
	const vk_debug_marker_object_tag_info_ext
		*p_tag_info) __asm("vkDebugMarkerSetObjectTagEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_debug_marker_set_object_name_ext(
	vk_device device,
	const vk_debug_marker_object_name_info_ext
		*p_name_info) __asm("vkDebugMarkerSetObjectNameEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_debug_marker_begin_ext(
	vk_command_buffer command_buffer,
	const vk_debug_marker_marker_info_ext
		*p_marker_info) __asm("vkCmdDebugMarkerBeginEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_debug_marker_insert_ext(
	vk_command_buffer command_buffer,
	const vk_debug_marker_marker_info_ext
		*p_marker_info) __asm("vkCmdDebugMarkerInsertEXT");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_transform_feedback_buffers_ext)(
	vk_command_buffer command_buffer, uint32_t first_binding,
	uint32_t binding_count, const vk_buffer *p_buffers,
	const vk_device_size *p_offsets, const vk_device_size *p_sizes);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_transform_feedback_ext)(
	vk_command_buffer command_buffer, uint32_t first_counter_buffer,
	uint32_t counter_buffer_count, const vk_buffer *p_counter_buffers,
	const vk_device_size *p_counter_buffer_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_transform_feedback_ext)(
	vk_command_buffer command_buffer, uint32_t first_counter_buffer,
	uint32_t counter_buffer_count, const vk_buffer *p_counter_buffers,
	const vk_device_size *p_counter_buffer_offsets);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_query_indexed_ext)(
	vk_command_buffer command_buffer, vk_query_pool query_pool,
	uint32_t query, vk_query_control_flags flags, uint32_t index);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_query_indexed_ext)(
	vk_command_buffer command_buffer, vk_query_pool query_pool,
	uint32_t query, uint32_t index);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_byte_count_ext)(
	vk_command_buffer command_buffer, uint32_t instance_count,
	uint32_t first_instance, vk_buffer counter_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_transform_feedback_buffers_ext(
	...
	uint32_t binding_count, const vk_buffer *p_buffers,
	const vk_device_size *p_offsets,
	const vk_device_size
		*p_sizes) __asm("vkCmdBindTransformFeedbackBuffersEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_transform_feedback_ext(
	vk_command_buffer command_buffer, uint32_t first_counter_buffer,
	uint32_t counter_buffer_count, const vk_buffer *p_counter_buffers,
	const vk_device_size *
		p_counter_buffer_offsets) __asm("vkCmdBeginTransformFeedbackEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_transform_feedback_ext(
	vk_command_buffer command_buffer, uint32_t first_counter_buffer,
	uint32_t counter_buffer_count, const vk_buffer *p_counter_buffers,
	const vk_device_size *
		p_counter_buffer_offsets) __asm("vkCmdEndTransformFeedbackEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_end_query_indexed_ext(
	vk_command_buffer command_buffer, vk_query_pool query_pool,
	uint32_t query, uint32_t index) __asm("vkCmdEndQueryIndexedEXT");
...
typedef uint32_t(VKAPI_PTR *pfn_vk_get_image_view_handle_nvx)(
	vk_device device, const vk_image_view_handle_info_nvx *p_info);
typedef vk_result(VKAPI_PTR *pfn_vk_get_image_view_address_nvx)(
	vk_device device, vk_image_view image_view,
	vk_image_view_address_properties_nvx *p_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR uint32_t VKAPI_CALL vk_get_image_view_handle_nvx(
	vk_device device, const vk_image_view_handle_info_nvx
				  *p_info) __asm("vkGetImageViewHandleNVX");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_image_view_address_nvx(
	vk_device device, vk_image_view image_view,
	vk_image_view_address_properties_nvx
		*p_properties) __asm("vkGetImageViewAddressNVX");
#endif

#define vk_amd_draw_indirect_count 1
#define VK_AMD_DRAW_INDIRECT_COUNT_SPEC_VERSION 2
#define VK_AMD_DRAW_INDIRECT_COUNT_EXTENSION_NAME "VK_AMD_draw_indirect_count"
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indirect_count_amd)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count_amd)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_shader_info_amd)(
	vk_device device, vk_pipeline pipeline,
	vk_shader_stage_flag_bits shader_stage,
	vk_shader_info_type_amd info_type, size_t *p_info_size, void *p_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL
vk_get_shader_info_amd(vk_device device, vk_pipeline pipeline,
		       vk_shader_stage_flag_bits shader_stage,
...
typedef struct vk_external_image_format_properties_nv {
	...
	vk_external_memory_handle_type_flags_nv
		export_from_imported_handle_types;
...
typedef vk_result(
	VKAPI_PTR *
		pfn_vk_get_physical_device_external_image_format_properties_nv)(
	vk_physical_device physical_device, vk_format format,
	vk_image_type type, vk_image_tiling tiling, vk_image_usage_flags usage,
	vk_image_create_flags flags,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_conditional_rendering_ext)(
	vk_command_buffer command_buffer,
	const vk_conditional_rendering_begin_info_ext
		*p_conditional_rendering_begin);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_conditional_rendering_ext)(
	vk_command_buffer command_buffer);
...
VKAPI_ATTR void VKAPI_CALL
vk_cmd_end_conditional_rendering_ext(vk_command_buffer command_buffer) __asm(
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_viewport_wscaling_nv)(
	vk_command_buffer command_buffer, uint32_t first_viewport,
	uint32_t viewport_count,
	const vk_viewport_wscaling_nv *p_viewport_wscalings);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_viewport_wscaling_nv(
	vk_command_buffer command_buffer, uint32_t first_viewport,
	uint32_t viewport_count,
	const vk_viewport_wscaling_nv
		*p_viewport_wscalings) __asm("vkCmdSetViewportWScalingNV");
#endif

#define vk_ext_direct_mode_display 1
#define VK_EXT_DIRECT_MODE_DISPLAY_SPEC_VERSION 1
#define VK_EXT_DIRECT_MODE_DISPLAY_EXTENSION_NAME "VK_EXT_direct_mode_display"
typedef vk_result(VKAPI_PTR *pfn_vk_release_display_ext)(
	vk_physical_device physical_device, vk_display_khr display);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL
vk_release_display_ext(vk_physical_device physical_device,
...
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_surface_capabilities2ext)(
	vk_physical_device physical_device, vk_surface_khr surface,
	vk_surface_capabilities2ext *p_surface_capabilities);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_surface_capabilities2ext(
	vk_physical_device physical_device, vk_surface_khr surface,
	vk_surface_capabilities2ext *
		p_surface_capabilities) __asm("vkGetPhysicalDeviceSurfaceCapabilities2EXT");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_display_power_control_ext)(
	vk_device device, vk_display_khr display,
	const vk_display_power_info_ext *p_display_power_info);
typedef vk_result(VKAPI_PTR *pfn_vk_register_device_event_ext)(
	vk_device device, const vk_device_event_info_ext *p_device_event_info,
	const vk_allocation_callbacks *p_allocator, vk_fence *p_fence);
typedef vk_result(VKAPI_PTR *pfn_vk_register_display_event_ext)(
	vk_device device, vk_display_khr display,
	const vk_display_event_info_ext *p_display_event_info,
	const vk_allocation_callbacks *p_allocator, vk_fence *p_fence);
typedef vk_result(VKAPI_PTR *pfn_vk_get_swapchain_counter_ext)(
	vk_device device, vk_swapchain_khr swapchain,
	vk_surface_counter_flag_bits_ext counter, uint64_t *p_counter_value);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_display_power_control_ext(
	vk_device device, vk_display_khr display,
	const vk_display_power_info_ext
		*p_display_power_info) __asm("vkDisplayPowerControlEXT");
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_refresh_cycle_duration_google)(
	vk_device device, vk_swapchain_khr swapchain,
	vk_refresh_cycle_duration_google *p_display_timing_properties);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_refresh_cycle_duration_google(
	vk_device device, vk_swapchain_khr swapchain,
	vk_refresh_cycle_duration_google *
		p_display_timing_properties) __asm("vkGetRefreshCycleDurationGOOGLE");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_past_presentation_timing_google(
	vk_device device, vk_swapchain_khr swapchain,
	uint32_t *p_presentation_timing_count,
	vk_past_presentation_timing_google *
		p_presentation_timings) __asm("vkGetPastPresentationTimingGOOGLE");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_discard_rectangle_ext)(
	vk_command_buffer command_buffer, uint32_t first_discard_rectangle,
	uint32_t discard_rectangle_count,
	const vk_rect2d *p_discard_rectangles);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_discard_rectangle_ext(
	...
	uint32_t discard_rectangle_count,
	const vk_rect2d
		*p_discard_rectangles) __asm("vkCmdSetDiscardRectangleEXT");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_set_hdr_metadata_ext)(
	vk_device device, uint32_t swapchain_count,
	const vk_swapchain_khr *p_swapchains,
...
typedef vk_result(VKAPI_PTR *pfn_vk_set_debug_utils_object_name_ext)(
	vk_device device,
	const vk_debug_utils_object_name_info_ext *p_name_info);
...
typedef void(VKAPI_PTR *pfn_vk_queue_begin_debug_utils_label_ext)(
	vk_queue queue, const vk_debug_utils_label_ext *p_label_info);
typedef void(VKAPI_PTR *pfn_vk_queue_end_debug_utils_label_ext)(vk_queue queue);
typedef void(VKAPI_PTR *pfn_vk_queue_insert_debug_utils_label_ext)(
	vk_queue queue, const vk_debug_utils_label_ext *p_label_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_begin_debug_utils_label_ext)(
	vk_command_buffer command_buffer,
	const vk_debug_utils_label_ext *p_label_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_end_debug_utils_label_ext)(
	vk_command_buffer command_buffer);
typedef void(VKAPI_PTR *pfn_vk_cmd_insert_debug_utils_label_ext)(
	vk_command_buffer command_buffer,
	const vk_debug_utils_label_ext *p_label_info);
typedef vk_result(VKAPI_PTR *pfn_vk_create_debug_utils_messenger_ext)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_debug_utils_messenger_ext *p_messenger);
typedef void(VKAPI_PTR *pfn_vk_destroy_debug_utils_messenger_ext)(
...
VKAPI_ATTR vk_result VKAPI_CALL vk_set_debug_utils_object_name_ext(
	vk_device device,
	const vk_debug_utils_object_name_info_ext
		*p_name_info) __asm("vkSetDebugUtilsObjectNameEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_set_debug_utils_object_tag_ext(
	vk_device device,
	const vk_debug_utils_object_tag_info_ext
		*p_tag_info) __asm("vkSetDebugUtilsObjectTagEXT");

VKAPI_ATTR void VKAPI_CALL vk_queue_begin_debug_utils_label_ext(
	vk_queue queue,
	const vk_debug_utils_label_ext
		*p_label_info) __asm("vkQueueBeginDebugUtilsLabelEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_queue_insert_debug_utils_label_ext(
	vk_queue queue,
	const vk_debug_utils_label_ext
		*p_label_info) __asm("vkQueueInsertDebugUtilsLabelEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_debug_utils_label_ext(
	vk_command_buffer command_buffer,
	const vk_debug_utils_label_ext
		*p_label_info) __asm("vkCmdBeginDebugUtilsLabelEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_insert_debug_utils_label_ext(
	vk_command_buffer command_buffer,
	const vk_debug_utils_label_ext
		*p_label_info) __asm("vkCmdInsertDebugUtilsLabelEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_debug_utils_messenger_ext(
	vk_instance instance,
	const vk_debug_utils_messenger_create_info_ext *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_debug_utils_messenger_ext
		*p_messenger) __asm("vkCreateDebugUtilsMessengerEXT");

VKAPI_ATTR void VKAPI_CALL vk_destroy_debug_utils_messenger_ext(
	vk_instance instance, vk_debug_utils_messenger_ext messenger,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyDebugUtilsMessengerEXT");

VKAPI_ATTR void VKAPI_CALL vk_submit_debug_utils_message_ext(
	vk_instance instance,
	vk_debug_utils_message_severity_flag_bits_ext message_severity,
	vk_debug_utils_message_type_flags_ext message_types,
	const vk_debug_utils_messenger_callback_data_ext
		*p_callback_data) __asm("vkSubmitDebugUtilsMessageEXT");
#endif
...
typedef vk_sampler_reduction_mode_create_info
	vk_sampler_reduction_mode_create_info_ext;

typedef vk_physical_device_sampler_filter_minmax_properties
	vk_physical_device_sampler_filter_minmax_properties_ext;
...
typedef struct vk_render_pass_sample_locations_begin_info_ext {
	...
	const vk_attachment_sample_locations_ext
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_sample_locations_ext)(
	vk_command_buffer command_buffer,
	const vk_sample_locations_info_ext *p_sample_locations_info);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_sample_locations_ext(
	vk_command_buffer command_buffer,
	const vk_sample_locations_info_ext
		*p_sample_locations_info) __asm("vkCmdSetSampleLocationsEXT");

VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_multisample_properties_ext(
	vk_physical_device physical_device, vk_sample_count_flag_bits samples,
	vk_multisample_properties_ext *
		p_multisample_properties) __asm("vkGetPhysicalDeviceMultisamplePropertiesEXT");
#endif
...
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_image_drm_format_modifier_properties_ext)(
	vk_device device, vk_image image,
	vk_image_drm_format_modifier_properties_ext *p_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_image_drm_format_modifier_properties_ext(
	vk_device device, vk_image image,
	vk_image_drm_format_modifier_properties_ext *
		p_properties) __asm("vkGetImageDrmFormatModifierPropertiesEXT");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_validation_cache_ext)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_validation_cache_ext *p_validation_cache);
typedef void(VKAPI_PTR *pfn_vk_destroy_validation_cache_ext)(
	vk_device device, vk_validation_cache_ext validation_cache,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_merge_validation_caches_ext)(
	vk_device device, vk_validation_cache_ext dst_cache,
	uint32_t src_cache_count, const vk_validation_cache_ext *p_src_caches);
typedef vk_result(VKAPI_PTR *pfn_vk_get_validation_cache_data_ext)(
	vk_device device, vk_validation_cache_ext validation_cache,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_validation_cache_ext(
	...
	const vk_validation_cache_create_info_ext *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_validation_cache_ext
		*p_validation_cache) __asm("vkCreateValidationCacheEXT");

VKAPI_ATTR void VKAPI_CALL vk_destroy_validation_cache_ext(
	vk_device device, vk_validation_cache_ext validation_cache,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyValidationCacheEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_merge_validation_caches_ext(
	vk_device device, vk_validation_cache_ext dst_cache,
	uint32_t src_cache_count,
	const vk_validation_cache_ext
		*p_src_caches) __asm("vkMergeValidationCachesEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_validation_cache_data_ext(
	vk_device device, vk_validation_cache_ext validation_cache,
	size_t *p_data_size, void *p_data) __asm("vkGetValidationCacheDataEXT");
#endif
...
typedef vk_descriptor_set_layout_binding_flags_create_info
	vk_descriptor_set_layout_binding_flags_create_info_ext;

typedef vk_physical_device_descriptor_indexing_features
	vk_physical_device_descriptor_indexing_features_ext;

typedef vk_physical_device_descriptor_indexing_properties
	vk_physical_device_descriptor_indexing_properties_ext;
...
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_shading_rate_image_nv)(
	vk_command_buffer command_buffer, vk_image_view image_view,
	vk_image_layout image_layout);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_viewport_shading_rate_palette_nv(
	vk_command_buffer command_buffer, uint32_t first_viewport,
	uint32_t viewport_count,
	const vk_shading_rate_palette_nv *
		p_shading_rate_palettes) __asm("vkCmdSetViewportShadingRatePaletteNV");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_coarse_sample_order_nv(
	vk_command_buffer command_buffer,
	vk_coarse_sample_order_type_nv sample_order_type,
	uint32_t custom_sample_order_count,
	const vk_coarse_sample_order_custom_nv
		*p_custom_sample_orders) __asm("vkCmdSetCoarseSampleOrderNV");
#endif
...
typedef vk_copy_acceleration_structure_mode_khr
	vk_copy_acceleration_structure_mode_nv;
...
typedef vk_acceleration_structure_memory_requirements_type_khr
	vk_acceleration_structure_memory_requirements_type_nv;
...
typedef vk_build_acceleration_structure_flags_khr
	vk_build_acceleration_structure_flags_nv;

typedef vk_build_acceleration_structure_flag_bits_khr
	vk_build_acceleration_structure_flag_bits_nv;
...
typedef vk_bind_acceleration_structure_memory_info_khr
	vk_bind_acceleration_structure_memory_info_nv;
...
typedef vk_write_descriptor_set_acceleration_structure_khr
	vk_write_descriptor_set_acceleration_structure_nv;
...
typedef vk_acceleration_structure_instance_khr
	vk_acceleration_structure_instance_nv;
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_acceleration_structure_nv)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_acceleration_structure_nv *p_acceleration_structure);
typedef void(VKAPI_PTR *pfn_vk_destroy_acceleration_structure_khr)(
	vk_device device, vk_acceleration_structure_khr acceleration_structure,
	const vk_allocation_callbacks *p_allocator);
typedef void(VKAPI_PTR *pfn_vk_destroy_acceleration_structure_nv)(
	vk_device device, vk_acceleration_structure_khr acceleration_structure,
	const vk_allocation_callbacks *p_allocator);
typedef void(
	VKAPI_PTR *pfn_vk_get_acceleration_structure_memory_requirements_nv)(
	vk_device device,
...
typedef vk_result(VKAPI_PTR *pfn_vk_bind_acceleration_structure_memory_khr)(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_acceleration_structure_memory_info_khr *p_bind_infos);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_build_acceleration_structure_nv)(
	...
	vk_buffer instance_data, vk_device_size instance_offset,
	vk_bool32 update, vk_acceleration_structure_khr dst,
	vk_acceleration_structure_khr src, vk_buffer scratch,
	vk_device_size scratch_offset);
typedef void(VKAPI_PTR *pfn_vk_cmd_copy_acceleration_structure_nv)(
	vk_command_buffer command_buffer, vk_acceleration_structure_khr dst,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_trace_rays_nv)(
	...
	vk_device_size callable_shader_binding_stride, uint32_t width,
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_ray_tracing_pipelines_nv)(
	...
	const vk_allocation_callbacks *p_allocator, vk_pipeline *p_pipelines);
typedef vk_result(VKAPI_PTR *pfn_vk_get_ray_tracing_shader_group_handles_khr)(
	vk_device device, vk_pipeline pipeline, uint32_t first_group,
	uint32_t group_count, size_t data_size, void *p_data);
typedef vk_result(VKAPI_PTR *pfn_vk_get_ray_tracing_shader_group_handles_nv)(
	vk_device device, vk_pipeline pipeline, uint32_t first_group,
	uint32_t group_count, size_t data_size, void *p_data);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_write_acceleration_structures_properties_khr)(
	...
	const vk_acceleration_structure_khr *p_acceleration_structures,
	vk_query_type query_type, vk_query_pool query_pool,
	uint32_t first_query);
typedef void(VKAPI_PTR *pfn_vk_cmd_write_acceleration_structures_properties_nv)(
	...
	vk_query_type query_type, vk_query_pool query_pool,
	uint32_t first_query);
typedef vk_result(VKAPI_PTR *pfn_vk_compile_deferred_nv)(vk_device device,
							 vk_pipeline pipeline,
							 uint32_t shader);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_acceleration_structure_nv(
	...
	vk_acceleration_structure_nv *
		p_acceleration_structure) __asm("vkCreateAccelerationStructureNV");

VKAPI_ATTR void VKAPI_CALL vk_destroy_acceleration_structure_khr(
	vk_device device, vk_acceleration_structure_khr acceleration_structure,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyAccelerationStructureKHR");

VKAPI_ATTR void VKAPI_CALL vk_destroy_acceleration_structure_nv(
	vk_device device, vk_acceleration_structure_khr acceleration_structure,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyAccelerationStructureNV");

VKAPI_ATTR void VKAPI_CALL vk_get_acceleration_structure_memory_requirements_nv(
	vk_device device,
	const vk_acceleration_structure_memory_requirements_info_nv *p_info,
	vk_memory_requirements2khr *
		p_memory_requirements) __asm("vkGetAccelerationStructureMemoryRequirementsNV");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_acceleration_structure_memory_khr(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_acceleration_structure_memory_info_khr
		*p_bind_infos) __asm("vkBindAccelerationStructureMemoryKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_acceleration_structure_memory_nv(
	vk_device device, uint32_t bind_info_count,
	const vk_bind_acceleration_structure_memory_info_khr
		*p_bind_infos) __asm("vkBindAccelerationStructureMemoryNV");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_build_acceleration_structure_nv(
	...
	vk_acceleration_structure_khr src, vk_buffer scratch,
	vk_device_size
		scratch_offset) __asm("vkCmdBuildAccelerationStructureNV");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_acceleration_structure_nv(
	vk_command_buffer command_buffer, vk_acceleration_structure_khr dst,
	vk_acceleration_structure_khr src,
	vk_copy_acceleration_structure_mode_khr
		mode) __asm("vkCmdCopyAccelerationStructureNV");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_trace_rays_nv(
	...
	vk_device_size callable_shader_binding_offset,
	vk_device_size callable_shader_binding_stride, uint32_t width,
	uint32_t height, uint32_t depth) __asm("vkCmdTraceRaysNV");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_write_acceleration_structures_properties_khr(
	...
	vk_query_type query_type, vk_query_pool query_pool,
	uint32_t
		first_query) __asm("vkCmdWriteAccelerationStructuresPropertiesKHR");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_write_acceleration_structures_properties_nv(
	...
	vk_query_type query_type, vk_query_pool query_pool,
	uint32_t
		first_query) __asm("vkCmdWriteAccelerationStructuresPropertiesNV");

VKAPI_ATTR vk_result VKAPI_CALL
vk_compile_deferred_nv(vk_device device, vk_pipeline pipeline,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_write_buffer_marker_amd)(
	vk_command_buffer command_buffer,
	vk_pipeline_stage_flag_bits pipeline_stage, vk_buffer dst_buffer,
	vk_device_size dst_offset, uint32_t marker);
...
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_calibrateable_time_domains_ext)(
	vk_physical_device physical_device, uint32_t *p_time_domain_count,
	vk_time_domain_ext *p_time_domains);
typedef vk_result(VKAPI_PTR *pfn_vk_get_calibrated_timestamps_ext)(
	vk_device device, uint32_t timestamp_count,
...
vk_get_physical_device_calibrateable_time_domains_ext(
	vk_physical_device physical_device, uint32_t *p_time_domain_count,
	vk_time_domain_ext *
		p_time_domains) __asm("vkGetPhysicalDeviceCalibrateableTimeDomainsEXT");
...
typedef struct vk_pipeline_vertex_input_divisor_state_create_info_ext {
	...
	const vk_vertex_input_binding_divisor_description_ext
...
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_nv)(
	vk_command_buffer command_buffer, uint32_t task_count,
	uint32_t first_task);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_indirect_nv)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, uint32_t draw_count, uint32_t stride);
typedef void(VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_indirect_count_nv)(
	vk_command_buffer command_buffer, vk_buffer buffer,
	vk_device_size offset, vk_buffer count_buffer,
	vk_device_size count_buffer_offset, uint32_t max_draw_count,
	uint32_t stride);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL
vk_cmd_draw_mesh_tasks_nv(vk_command_buffer command_buffer, uint32_t task_count,
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_exclusive_scissor_nv)(
	vk_command_buffer command_buffer, uint32_t first_exclusive_scissor,
	uint32_t exclusive_scissor_count,
	const vk_rect2d *p_exclusive_scissors);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_exclusive_scissor_nv(
	...
	uint32_t exclusive_scissor_count,
	const vk_rect2d
		*p_exclusive_scissors) __asm("vkCmdSetExclusiveScissorNV");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_checkpoint_nv)(
	vk_command_buffer command_buffer, const void *p_checkpoint_marker);
typedef void(VKAPI_PTR *pfn_vk_get_queue_checkpoint_data_nv)(
	vk_queue queue, uint32_t *p_checkpoint_data_count,
...
VKAPI_ATTR void VKAPI_CALL vk_get_queue_checkpoint_data_nv(
	vk_queue queue, uint32_t *p_checkpoint_data_count,
	vk_checkpoint_data_nv
		*p_checkpoint_data) __asm("vkGetQueueCheckpointDataNV");
#endif
...
typedef vk_query_pool_performance_query_create_info_intel
	vk_query_pool_create_info_intel;
...
typedef vk_result(VKAPI_PTR *pfn_vk_initialize_performance_api_intel)(
	vk_device device,
	const vk_initialize_performance_api_info_intel *p_initialize_info);
typedef void(VKAPI_PTR *pfn_vk_uninitialize_performance_api_intel)(
	vk_device device);
typedef vk_result(VKAPI_PTR *pfn_vk_cmd_set_performance_marker_intel)(
	vk_command_buffer command_buffer,
	const vk_performance_marker_info_intel *p_marker_info);
typedef vk_result(VKAPI_PTR *pfn_vk_cmd_set_performance_stream_marker_intel)(
	vk_command_buffer command_buffer,
	const vk_performance_stream_marker_info_intel *p_marker_info);
typedef vk_result(VKAPI_PTR *pfn_vk_cmd_set_performance_override_intel)(
	vk_command_buffer command_buffer,
	const vk_performance_override_info_intel *p_override_info);
...
typedef vk_result(VKAPI_PTR *pfn_vk_get_performance_parameter_intel)(
	vk_device device, vk_performance_parameter_type_intel parameter,
	vk_performance_value_intel *p_value);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_initialize_performance_api_intel(
	vk_device device,
	const vk_initialize_performance_api_info_intel
		*p_initialize_info) __asm("vkInitializePerformanceApiINTEL");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_cmd_set_performance_marker_intel(
	vk_command_buffer command_buffer,
	const vk_performance_marker_info_intel
		*p_marker_info) __asm("vkCmdSetPerformanceMarkerINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_cmd_set_performance_stream_marker_intel(
	vk_command_buffer command_buffer,
	const vk_performance_stream_marker_info_intel
		*p_marker_info) __asm("vkCmdSetPerformanceStreamMarkerINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_cmd_set_performance_override_intel(
	vk_command_buffer command_buffer,
	const vk_performance_override_info_intel
		*p_override_info) __asm("vkCmdSetPerformanceOverrideINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_performance_configuration_intel(
	vk_device device,
	const vk_performance_configuration_acquire_info_intel *p_acquire_info,
	vk_performance_configuration_intel *
		p_configuration) __asm("vkAcquirePerformanceConfigurationINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_release_performance_configuration_intel(
	vk_device device,
	vk_performance_configuration_intel
		configuration) __asm("vkReleasePerformanceConfigurationINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_queue_set_performance_configuration_intel(
	vk_queue queue,
	vk_performance_configuration_intel
		configuration) __asm("vkQueueSetPerformanceConfigurationINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_performance_parameter_intel(
	vk_device device, vk_performance_parameter_type_intel parameter,
	vk_performance_value_intel
		*p_value) __asm("vkGetPerformanceParameterINTEL");
#endif
...
typedef void(VKAPI_PTR *pfn_vk_set_local_dimming_amd)(
	vk_device device, vk_swapchain_khr swap_chain,
	vk_bool32 local_dimming_enable);
...
typedef vk_physical_device_scalar_block_layout_features
	vk_physical_device_scalar_block_layout_features_ext;
...
typedef vk_physical_device_buffer_device_address_features_ext
	vk_physical_device_buffer_address_features_ext;
...
typedef vk_device_address(VKAPI_PTR *pfn_vk_get_buffer_device_address_ext)(
	vk_device device, const vk_buffer_device_address_info *p_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_device_address VKAPI_CALL vk_get_buffer_device_address_ext(
	vk_device device, const vk_buffer_device_address_info
				  *p_info) __asm("vkGetBufferDeviceAddressEXT");
#endif
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_tool_properties_ext(
	vk_physical_device physical_device, uint32_t *p_tool_count,
	vk_physical_device_tool_properties_ext *
		p_tool_properties) __asm("vkGetPhysicalDeviceToolPropertiesEXT");
#endif
...
typedef vk_image_stencil_usage_create_info
	vk_image_stencil_usage_create_info_ext;
...
typedef vk_result(
	VKAPI_PTR *pfn_vk_get_physical_device_cooperative_matrix_properties_nv)(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_cooperative_matrix_properties_nv *p_properties);
...
vk_get_physical_device_cooperative_matrix_properties_nv(
	vk_physical_device physical_device, uint32_t *p_property_count,
	vk_cooperative_matrix_properties_nv *
		p_properties) __asm("vkGetPhysicalDeviceCooperativeMatrixPropertiesNV");
#endif
...
typedef vk_result(
	VKAPI_PTR *
		pfn_vk_get_physical_device_supported_framebuffer_mixed_samples_combinations_nv)(
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_line_stipple_ext)(
	vk_command_buffer command_buffer, uint32_t line_stipple_factor,
	uint16_t line_stipple_pattern);
...
typedef vk_physical_device_host_query_reset_features
	vk_physical_device_host_query_reset_features_ext;

typedef void(VKAPI_PTR *pfn_vk_reset_query_pool_ext)(vk_device device,
						     vk_query_pool query_pool,
						     uint32_t first_query,
						     uint32_t query_count);
...
typedef void(VKAPI_PTR *pfn_vk_cmd_set_cull_mode_ext)(
	vk_command_buffer command_buffer, vk_cull_mode_flags cull_mode);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_front_face_ext)(
	vk_command_buffer command_buffer, vk_front_face front_face);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_primitive_topology_ext)(
	vk_command_buffer command_buffer,
	vk_primitive_topology primitive_topology);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_viewport_with_count_ext)(
	vk_command_buffer command_buffer, uint32_t viewport_count,
	const vk_viewport *p_viewports);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_scissor_with_count_ext)(
	vk_command_buffer command_buffer, uint32_t scissor_count,
	const vk_rect2d *p_scissors);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_vertex_buffers2ext)(
	vk_command_buffer command_buffer, uint32_t first_binding,
	uint32_t binding_count, const vk_buffer *p_buffers,
	const vk_device_size *p_offsets, const vk_device_size *p_sizes,
	const vk_device_size *p_strides);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_test_enable_ext)(
	vk_command_buffer command_buffer, vk_bool32 depth_test_enable);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_write_enable_ext)(
	vk_command_buffer command_buffer, vk_bool32 depth_write_enable);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_compare_op_ext)(
	vk_command_buffer command_buffer, vk_compare_op depth_compare_op);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_depth_bounds_test_enable_ext)(
	vk_command_buffer command_buffer, vk_bool32 depth_bounds_test_enable);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_stencil_test_enable_ext)(
	vk_command_buffer command_buffer, vk_bool32 stencil_test_enable);
typedef void(VKAPI_PTR *pfn_vk_cmd_set_stencil_op_ext)(
	vk_command_buffer command_buffer, vk_stencil_face_flags face_mask,
	vk_stencil_op fail_op, vk_stencil_op pass_op,
	vk_stencil_op depth_fail_op, vk_compare_op compare_op);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_primitive_topology_ext(
	vk_command_buffer command_buffer,
	vk_primitive_topology
		primitive_topology) __asm("vkCmdSetPrimitiveTopologyEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_bounds_test_enable_ext(
	vk_command_buffer command_buffer,
	vk_bool32
		depth_bounds_test_enable) __asm("vkCmdSetDepthBoundsTestEnableEXT");
...
typedef void(VKAPI_PTR *pfn_vk_cmd_execute_generated_commands_nv)(
	...
	const vk_generated_commands_info_nv *p_generated_commands_info);
typedef void(VKAPI_PTR *pfn_vk_cmd_bind_pipeline_shader_group_nv)(
	vk_command_buffer command_buffer,
	vk_pipeline_bind_point pipeline_bind_point, vk_pipeline pipeline,
	uint32_t group_index);
typedef vk_result(VKAPI_PTR *pfn_vk_create_indirect_commands_layout_nv)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_indirect_commands_layout_nv *p_indirect_commands_layout);
...
VKAPI_ATTR void VKAPI_CALL vk_get_generated_commands_memory_requirements_nv(
	...
	const vk_generated_commands_memory_requirements_info_nv *p_info,
	vk_memory_requirements2 *
		p_memory_requirements) __asm("vkGetGeneratedCommandsMemoryRequirementsNV");

VKAPI_ATTR void VKAPI_CALL vk_cmd_preprocess_generated_commands_nv(
	vk_command_buffer command_buffer,
	const vk_generated_commands_info_nv *
		p_generated_commands_info) __asm("vkCmdPreprocessGeneratedCommandsNV");

VKAPI_ATTR void VKAPI_CALL vk_cmd_execute_generated_commands_nv(
	vk_command_buffer command_buffer, vk_bool32 is_preprocessed,
	const vk_generated_commands_info_nv *
		p_generated_commands_info) __asm("vkCmdExecuteGeneratedCommandsNV");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_indirect_commands_layout_nv(
	...
	const vk_indirect_commands_layout_create_info_nv *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_indirect_commands_layout_nv *
		p_indirect_commands_layout) __asm("vkCreateIndirectCommandsLayoutNV");

VKAPI_ATTR void VKAPI_CALL vk_destroy_indirect_commands_layout_nv(
	vk_device device,
	vk_indirect_commands_layout_nv indirect_commands_layout,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyIndirectCommandsLayoutNV");
#endif
...
typedef vk_result(VKAPI_PTR *pfn_vk_create_private_data_slot_ext)(
	...
	const vk_allocation_callbacks *p_allocator,
	vk_private_data_slot_ext *p_private_data_slot);
typedef void(VKAPI_PTR *pfn_vk_destroy_private_data_slot_ext)(
	vk_device device, vk_private_data_slot_ext private_data_slot,
	const vk_allocation_callbacks *p_allocator);
typedef vk_result(VKAPI_PTR *pfn_vk_set_private_data_ext)(
	vk_device device, vk_object_type object_type, uint64_t object_handle,
	vk_private_data_slot_ext private_data_slot, uint64_t data);
typedef void(VKAPI_PTR *pfn_vk_get_private_data_ext)(
	vk_device device, vk_object_type object_type, uint64_t object_handle,
	vk_private_data_slot_ext private_data_slot, uint64_t *p_data);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_private_data_slot_ext(
	...
	const vk_private_data_slot_create_info_ext *p_create_info,
	const vk_allocation_callbacks *p_allocator,
	vk_private_data_slot_ext
		*p_private_data_slot) __asm("vkCreatePrivateDataSlotEXT");

VKAPI_ATTR void VKAPI_CALL vk_destroy_private_data_slot_ext(
	vk_device device, vk_private_data_slot_ext private_data_slot,
	const vk_allocation_callbacks
		*p_allocator) __asm("vkDestroyPrivateDataSlotEXT");
